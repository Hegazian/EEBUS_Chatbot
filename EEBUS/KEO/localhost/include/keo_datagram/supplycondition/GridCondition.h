...
#ifndef KEO_DATAGRAM_SUPPLYCONDITION_GRIDCONDITION_H_
#define KEO_DATAGRAM_SUPPLYCONDITION_GRIDCONDITION_H_
...
/**
 * Declaration GridCondition
 */
class GridCondition : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 5;

  //! Enumeration GridCondition::Value
  enum class Value {
    UNDEFINED__ = -1,
    CONSUMPTION_RED,
    CONSUMPTION_YELLOW,
   ...
   */
  GridCondition::Value getValue() const;
   ...
   * @return enumeration value
   */
  GridCondition::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const GridCondition &other) const;
...
/**
 * \deprecated Use GridCondition instead.
 */
using GridConditionStruct = GridCondition;
...
#endif // KEO_DATAGRAM_SUPPLYCONDITION_GRIDCONDITION_H_