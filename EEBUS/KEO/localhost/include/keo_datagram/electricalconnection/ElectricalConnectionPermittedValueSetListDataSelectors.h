...
#ifndef KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONPERMITTEDVALUESETLISTDATASELECTORS_H_
#define KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONPERMITTEDVALUESETLISTDATASELECTORS_H_
...
/**
 * Declaration ElectricalConnectionPermittedValueSetListDataSelectors
 */
class ElectricalConnectionPermittedValueSetListDataSelectors
...
public:
   ...
   */
  bool operator==(const ElectricalConnectionPermittedValueSetListDataSelectors
                      &c_classObject) const;
   ...
   */
  bool selects(const ElectricalConnectionPermittedValueSetData &data) const;
...
//! ElectricalConnectionPermittedValueSetListDataSelectors
using ElectricalConnectionPermittedValueSetListDataSelectorsPtr =
    std::shared_ptr<ElectricalConnectionPermittedValueSetListDataSelectors>;

//! typedef for const type
//! ElectricalConnectionPermittedValueSetListDataSelectors
using ElectricalConnectionPermittedValueSetListDataSelectorsConst =
    const ElectricalConnectionPermittedValueSetListDataSelectors;

//! typedef for const type
//! ElectricalConnectionPermittedValueSetListDataSelectors
using ElectricalConnectionPermittedValueSetListDataSelectorsConstPtr =
    std::shared_ptr<
        ElectricalConnectionPermittedValueSetListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONPERMITTEDVALUESETLISTDATASELECTORS_H_