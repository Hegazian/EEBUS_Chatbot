...
#ifndef KEO_DATAGRAM_HVAC_HVACOVERRUNTYPE_H_
#define KEO_DATAGRAM_HVAC_HVACOVERRUNTYPE_H_
...
/**
 * Declaration HvacOverrunType
 */
class HvacOverrunType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 10;

  //! Enumeration HvacOverrunType::Value
  enum class Value {
    UNDEFINED__ = -1,
    ONE_TIME_DHW,
    PARTY,
   ...
   */
  HvacOverrunType::Value getValue() const;
   ...
   * @return enumeration value
   */
  HvacOverrunType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const HvacOverrunType &other) const;
...
/**
 * \deprecated Use HvacOverrunType instead.
 */
using HvacOverrunTypeStruct = HvacOverrunType;
...
#endif // KEO_DATAGRAM_HVAC_HVACOVERRUNTYPE_H_