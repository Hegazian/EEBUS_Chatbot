...
#ifndef KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONPOWERSEQUENCERELATIONLISTDATASELECTORS_H_
#define KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONPOWERSEQUENCERELATIONLISTDATASELECTORS_H_
...
/**
 * Declaration HvacSystemFunctionPowerSequenceRelationListDataSelectors
 */
class HvacSystemFunctionPowerSequenceRelationListDataSelectors
...
public:
   ...
   */
  explicit HvacSystemFunctionPowerSequenceRelationListDataSelectors(
   ...
   */
  bool operator==(const HvacSystemFunctionPowerSequenceRelationListDataSelectors
                      &c_classObject) const;
   ...
   */
  bool selects(const HvacSystemFunctionPowerSequenceRelationData &data) const;
...
//! HvacSystemFunctionPowerSequenceRelationListDataSelectors
using HvacSystemFunctionPowerSequenceRelationListDataSelectorsPtr =
    std::shared_ptr<HvacSystemFunctionPowerSequenceRelationListDataSelectors>;

//! typedef for const type
//! HvacSystemFunctionPowerSequenceRelationListDataSelectors
using HvacSystemFunctionPowerSequenceRelationListDataSelectorsConst =
    const HvacSystemFunctionPowerSequenceRelationListDataSelectors;

//! typedef for const type
//! HvacSystemFunctionPowerSequenceRelationListDataSelectors
using HvacSystemFunctionPowerSequenceRelationListDataSelectorsConstPtr =
    std::shared_ptr<
        HvacSystemFunctionPowerSequenceRelationListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONPOWERSEQUENCERELATIONLISTDATASELECTORS_H_