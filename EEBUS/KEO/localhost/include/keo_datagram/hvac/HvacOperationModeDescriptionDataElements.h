...
#ifndef KEO_DATAGRAM_HVAC_HVACOPERATIONMODEDESCRIPTIONDATAELEMENTS_H_
#define KEO_DATAGRAM_HVAC_HVACOPERATIONMODEDESCRIPTIONDATAELEMENTS_H_
...
/**
 * Declaration HvacOperationModeDescriptionDataElements
 */
class HvacOperationModeDescriptionDataElements : public DataElements {
public:
  /**
...
//! HvacOperationModeDescriptionDataElements
using HvacOperationModeDescriptionDataElementsPtr =
    std::shared_ptr<HvacOperationModeDescriptionDataElements>;

//! typedef for const type HvacOperationModeDescriptionDataElements
using HvacOperationModeDescriptionDataElementsConst =
    const HvacOperationModeDescriptionDataElements;

//! typedef for const type HvacOperationModeDescriptionDataElements
using HvacOperationModeDescriptionDataElementsConstPtr =
    std::shared_ptr<HvacOperationModeDescriptionDataElementsConst>;
...
#endif // KEO_DATAGRAM_HVAC_HVACOPERATIONMODEDESCRIPTIONDATAELEMENTS_H_