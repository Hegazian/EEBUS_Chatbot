...
#ifndef KEO_DATAGRAM_SETPOINT_SETPOINTDESCRIPTIONDATAELEMENTS_H_
#define KEO_DATAGRAM_SETPOINT_SETPOINTDESCRIPTIONDATAELEMENTS_H_
...
/**
 * Declaration SetpointDescriptionDataElements
 */
class SetpointDescriptionDataElements : public DataElements {
public:
  /**
   ...
   */
  bool operator==(const SetpointDescriptionDataElements &c_classObject) const;
...
//! typedef for non-const smart pointer type SetpointDescriptionDataElements
using SetpointDescriptionDataElementsPtr =
    std::shared_ptr<SetpointDescriptionDataElements>;

//! typedef for const type SetpointDescriptionDataElements
using SetpointDescriptionDataElementsConst =
    const SetpointDescriptionDataElements;

//! typedef for const type SetpointDescriptionDataElements
using SetpointDescriptionDataElementsConstPtr =
    std::shared_ptr<SetpointDescriptionDataElementsConst>;
...
#endif // KEO_DATAGRAM_SETPOINT_SETPOINTDESCRIPTIONDATAELEMENTS_H_