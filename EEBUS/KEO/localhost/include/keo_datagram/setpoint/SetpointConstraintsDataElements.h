...
#ifndef KEO_DATAGRAM_SETPOINT_SETPOINTCONSTRAINTSDATAELEMENTS_H_
#define KEO_DATAGRAM_SETPOINT_SETPOINTCONSTRAINTSDATAELEMENTS_H_
...
/**
 * Declaration SetpointConstraintsDataElements
 */
class SetpointConstraintsDataElements : public DataElements {
public:
  /**
   ...
   */
  bool operator==(const SetpointConstraintsDataElements &c_classObject) const;
   ...
   */
  void setSetpointRangeMin(const ScaledNumberElements &c_setpointRangeMin);

  /**
   * Returns const reference to member SetpointRangeMin.
   * @return const reference to member setpointRangeMin
   */
  const ScaledNumberElements &getSetpointRangeMin() const;
   ...
   */
  void setSetpointRangeMax(const ScaledNumberElements &c_setpointRangeMax);

  /**
   * Returns const reference to member SetpointRangeMax.
   * @return const reference to member setpointRangeMax
   */
  const ScaledNumberElements &getSetpointRangeMax() const;
   ...
   */
  void setSetpointStepSize(const ScaledNumberElements &c_setpointStepSize);

  /**
   * Returns const reference to member SetpointStepSize.
   * @return const reference to member setpointStepSize
   */
  const ScaledNumberElements &getSetpointStepSize() const;
...
private:
  ...
  ScaledNumberElements m_setpointRangeMin;

  bool m_setpointRangeMaxIsSet;
  ScaledNumberElements m_setpointRangeMax;

  bool m_setpointStepSizeIsSet;
  ScaledNumberElements m_setpointStepSize;
};

//! typedef for non-const smart pointer type SetpointConstraintsDataElements
using SetpointConstraintsDataElementsPtr =
    std::shared_ptr<SetpointConstraintsDataElements>;

//! typedef for const type SetpointConstraintsDataElements
using SetpointConstraintsDataElementsConst =
    const SetpointConstraintsDataElements;

//! typedef for const type SetpointConstraintsDataElements
using SetpointConstraintsDataElementsConstPtr =
    std::shared_ptr<SetpointConstraintsDataElementsConst>;
...
#endif // KEO_DATAGRAM_SETPOINT_SETPOINTCONSTRAINTSDATAELEMENTS_H_