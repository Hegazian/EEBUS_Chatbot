...
#ifndef KEO_DATAGRAM_SETPOINT_SETPOINTTYPE_H_
#define KEO_DATAGRAM_SETPOINT_SETPOINTTYPE_H_
...
/**
 * Declaration SetpointType
 */
class SetpointType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 2;

  //! Enumeration SetpointType::Value
  enum class Value { UNDEFINED__ = -1, VALUE_ABSOLUTE, VALUE_RELATIVE };
   ...
   */
  SetpointType::Value getValue() const;
   ...
   * @return enumeration value
   */
  SetpointType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const SetpointType &other) const;
...
/**
 * \deprecated Use SetpointType instead.
 */
using SetpointTypeStruct = SetpointType;
...
#endif // KEO_DATAGRAM_SETPOINT_SETPOINTTYPE_H_