...
#ifndef KEO_DATAGRAM_TIMESERIES_TIMESERIESTYPE_H_
#define KEO_DATAGRAM_TIMESERIES_TIMESERIESTYPE_H_
...
/**
 * Declaration TimeSeriesType
 */
class TimeSeriesType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 3;

  //! Enumeration TimeSeriesType::Value
  enum class Value { UNDEFINED__ = -1, PLAN, SINGLE_DEMAND, CONSTRAINTS };
   ...
   */
  TimeSeriesType::Value getValue() const;
   ...
   * @return enumeration value
   */
  TimeSeriesType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const TimeSeriesType &other) const;
...
/**
 * \deprecated Use TimeSeriesType instead.
 */
using TimeSeriesTypeStruct = TimeSeriesType;
...
#endif // KEO_DATAGRAM_TIMESERIES_TIMESERIESTYPE_H_