...
#ifndef KEO_DATAGRAM_INCENTIVETABLE_INCENTIVEDESCRIPTIONDATAELEMENTS_H_
#define KEO_DATAGRAM_INCENTIVETABLE_INCENTIVEDESCRIPTIONDATAELEMENTS_H_
...
/**
 * Declaration IncentiveDescriptionDataElements
 */
class IncentiveDescriptionDataElements : public DataElements {
public:
  /**
   ...
   */
  bool operator==(const IncentiveDescriptionDataElements &c_classObject) const;
...
//! typedef for non-const smart pointer type IncentiveDescriptionDataElements
using IncentiveDescriptionDataElementsPtr =
    std::shared_ptr<IncentiveDescriptionDataElements>;

//! typedef for const type IncentiveDescriptionDataElements
using IncentiveDescriptionDataElementsConst =
    const IncentiveDescriptionDataElements;

//! typedef for const type IncentiveDescriptionDataElements
using IncentiveDescriptionDataElementsConstPtr =
    std::shared_ptr<IncentiveDescriptionDataElementsConst>;
...
#endif // KEO_DATAGRAM_INCENTIVETABLE_INCENTIVEDESCRIPTIONDATAELEMENTS_H_