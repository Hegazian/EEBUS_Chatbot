...
#ifndef KEO_DATAGRAM_INCENTIVETABLE_INCENTIVETABLEDESCRIPTIONTIERELEMENTS_H_
#define KEO_DATAGRAM_INCENTIVETABLE_INCENTIVETABLEDESCRIPTIONTIERELEMENTS_H_
...
/**
 * Declaration IncentiveTableDescriptionTierElements
 */
class IncentiveTableDescriptionTierElements : public KeoJsonTransformable {
public:
  /**
   * Construct an empty instance.
   */
  IncentiveTableDescriptionTierElements();
   ...
   */
  void setTierDescription(const TierDescriptionDataElements &c_tierDescription);

  /**
   * Returns const reference to member TierDescription.
   * @return const reference to member tierDescription
   */
  const TierDescriptionDataElements &getTierDescription() const;
   ...
   */
  const TierBoundaryDescriptionDataElements &getBoundaryDescription() const;
   ...
   */
  const IncentiveDescriptionDataElements &getIncentiveDescription() const;
...
private:
  ...
  TierDescriptionDataElements m_tierDescription;

  bool m_boundaryDescriptionIsSet;
  TierBoundaryDescriptionDataElements m_boundaryDescription;

  bool m_incentiveDescriptionIsSet;
  IncentiveDescriptionDataElements m_incentiveDescription;
};

//! typedef for non-const smart pointer type
//! IncentiveTableDescriptionTierElements
using IncentiveTableDescriptionTierElementsPtr =
    std::shared_ptr<IncentiveTableDescriptionTierElements>;

//! typedef for const type IncentiveTableDescriptionTierElements
using IncentiveTableDescriptionTierElementsConst =
    const IncentiveTableDescriptionTierElements;

//! typedef for const type IncentiveTableDescriptionTierElements
using IncentiveTableDescriptionTierElementsConstPtr =
    std::shared_ptr<IncentiveTableDescriptionTierElementsConst>;
...
#endif // KEO_DATAGRAM_INCENTIVETABLE_INCENTIVETABLEDESCRIPTIONTIERELEMENTS_H_