...
#ifndef KEO_DATAGRAM_INCENTIVETABLE_INCENTIVETABLEELEMENTS_H_
#define KEO_DATAGRAM_INCENTIVETABLE_INCENTIVETABLEELEMENTS_H_
...
/**
 * Declaration IncentiveTableElements
 */
class IncentiveTableElements : public KeoJsonTransformable {
public:
  /**
   * Construct an empty instance.
   */
  IncentiveTableElements();
   ...
   */
  bool operator==(const IncentiveTableElements &c_classObject) const;
   ...
   */
  void
  setIncentiveSlot(const IncentiveTableIncentiveSlotElements &c_incentiveSlot);

  /**
   * Returns const reference to member IncentiveSlot.
   * @return const reference to member incentiveSlot
   */
  const IncentiveTableIncentiveSlotElements &getIncentiveSlot() const;
...
private:
  ...
  IncentiveTableIncentiveSlotElements m_incentiveSlot;
};

//! typedef for non-const smart pointer type IncentiveTableElements
using IncentiveTableElementsPtr = std::shared_ptr<IncentiveTableElements>;

//! typedef for const type IncentiveTableElements
using IncentiveTableElementsConst = const IncentiveTableElements;

//! typedef for const type IncentiveTableElements
using IncentiveTableElementsConstPtr =
    std::shared_ptr<IncentiveTableElementsConst>;
...
#endif // KEO_DATAGRAM_INCENTIVETABLE_INCENTIVETABLEELEMENTS_H_