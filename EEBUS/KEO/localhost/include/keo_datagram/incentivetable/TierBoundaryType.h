...
#ifndef KEO_DATAGRAM_INCENTIVETABLE_TIERBOUNDARYTYPE_H_
#define KEO_DATAGRAM_INCENTIVETABLE_TIERBOUNDARYTYPE_H_
...
/**
 * Declaration TierBoundaryType
 */
class TierBoundaryType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 3;

  //! Enumeration TierBoundaryType::Value
  enum class Value {
    UNDEFINED__ = -1,
    POWER_BOUNDARY,
    ENERGY_BOUNDARY,
   ...
   */
  TierBoundaryType::Value getValue() const;
   ...
   * @return enumeration value
   */
  TierBoundaryType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const TierBoundaryType &other) const;
...
/**
 * \deprecated Use TierBoundaryType instead.
 */
using TierBoundaryTypeStruct = TierBoundaryType;
...
#endif // KEO_DATAGRAM_INCENTIVETABLE_TIERBOUNDARYTYPE_H_