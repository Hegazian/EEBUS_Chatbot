...
#ifndef KEO_DATAGRAM_INCENTIVETABLE_TARIFFBOUNDARYRELATIONDATA_H_
#define KEO_DATAGRAM_INCENTIVETABLE_TARIFFBOUNDARYRELATIONDATA_H_
...
/**
 * Declaration TariffBoundaryRelationData
 */
class TariffBoundaryRelationData : public KeoJsonTransformable {
public:
  /**
   ...
   */
  TariffBoundaryRelationData(const xs_unsignedInt &c_tariffId,
   ...
   */
  bool operator==(const TariffBoundaryRelationData &c_classObject) const;
   ...
   */
  void setBoundaryId(const std::vector<xs_unsignedInt> &c_boundaryId);

  /**
   * Returns const reference to member BoundaryId.
   * @return const reference to member boundaryId
   */
  const std::vector<xs_unsignedInt> &getBoundaryId() const;
   ...
   */
  TariffBoundaryRelationData
  reduce(const TariffBoundaryRelationDataElements &elements) const;
...
private:
  ...
  std::vector<xs_unsignedInt> m_boundaryId;
};

//! typedef for non-const smart pointer type TariffBoundaryRelationData
using TariffBoundaryRelationDataPtr =
    std::shared_ptr<TariffBoundaryRelationData>;

//! typedef for const type TariffBoundaryRelationData
using TariffBoundaryRelationDataConst = const TariffBoundaryRelationData;

//! typedef for const type TariffBoundaryRelationData
using TariffBoundaryRelationDataConstPtr =
    std::shared_ptr<TariffBoundaryRelationDataConst>;
...
#endif // KEO_DATAGRAM_INCENTIVETABLE_TARIFFBOUNDARYRELATIONDATA_H_