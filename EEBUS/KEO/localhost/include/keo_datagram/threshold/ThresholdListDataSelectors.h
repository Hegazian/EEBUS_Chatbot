...
#ifndef KEO_DATAGRAM_THRESHOLD_THRESHOLDLISTDATASELECTORS_H_
#define KEO_DATAGRAM_THRESHOLD_THRESHOLDLISTDATASELECTORS_H_
...
/**
 * Declaration ThresholdListDataSelectors
 */
class ThresholdListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit ThresholdListDataSelectors(const xs_unsignedInt &c_thresholdId);
   ...
   */
  bool operator==(const ThresholdListDataSelectors &c_classObject) const;
   ...
   */
  bool selects(const ThresholdData &data) const;
...
//! typedef for non-const smart pointer type ThresholdListDataSelectors
using ThresholdListDataSelectorsPtr =
    std::shared_ptr<ThresholdListDataSelectors>;

//! typedef for const type ThresholdListDataSelectors
using ThresholdListDataSelectorsConst = const ThresholdListDataSelectors;

//! typedef for const type ThresholdListDataSelectors
using ThresholdListDataSelectorsConstPtr =
    std::shared_ptr<ThresholdListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_THRESHOLD_THRESHOLDLISTDATASELECTORS_H_