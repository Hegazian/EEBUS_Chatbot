...
#ifndef KEO_DATAGRAM_CORE_BINDINGMANAGEMENTDELETECALLELEMENTS_H_
#define KEO_DATAGRAM_CORE_BINDINGMANAGEMENTDELETECALLELEMENTS_H_
...
/**
 * Declaration BindingManagementDeleteCallElements
 */
class BindingManagementDeleteCallElements : public DataElements {
public:
  /**
...
//! typedef for non-const smart pointer type BindingManagementDeleteCallElements
using BindingManagementDeleteCallElementsPtr =
    std::shared_ptr<BindingManagementDeleteCallElements>;

//! typedef for const type BindingManagementDeleteCallElements
using BindingManagementDeleteCallElementsConst =
    const BindingManagementDeleteCallElements;

//! typedef for const type BindingManagementDeleteCallElements
using BindingManagementDeleteCallElementsConstPtr =
    std::shared_ptr<BindingManagementDeleteCallElementsConst>;
...
#endif // KEO_DATAGRAM_CORE_BINDINGMANAGEMENTDELETECALLELEMENTS_H_