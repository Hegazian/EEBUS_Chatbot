...
#ifndef KEO_DATAGRAM_CORE_NETWORKMANAGEMENTADDNODECALLELEMENTS_H_
#define KEO_DATAGRAM_CORE_NETWORKMANAGEMENTADDNODECALLELEMENTS_H_
...
/**
 * Declaration NetworkManagementAddNodeCallElements
 */
class NetworkManagementAddNodeCallElements : public DataElements {
public:
  /**
...
//! NetworkManagementAddNodeCallElements
using NetworkManagementAddNodeCallElementsPtr =
    std::shared_ptr<NetworkManagementAddNodeCallElements>;

//! typedef for const type NetworkManagementAddNodeCallElements
using NetworkManagementAddNodeCallElementsConst =
    const NetworkManagementAddNodeCallElements;

//! typedef for const type NetworkManagementAddNodeCallElements
using NetworkManagementAddNodeCallElementsConstPtr =
    std::shared_ptr<NetworkManagementAddNodeCallElementsConst>;
...
#endif // KEO_DATAGRAM_CORE_NETWORKMANAGEMENTADDNODECALLELEMENTS_H_