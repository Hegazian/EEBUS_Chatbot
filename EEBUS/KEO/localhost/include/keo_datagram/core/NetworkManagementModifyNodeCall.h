...
#ifndef KEO_DATAGRAM_CORE_NETWORKMANAGEMENTMODIFYNODECALL_H_
#define KEO_DATAGRAM_CORE_NETWORKMANAGEMENTMODIFYNODECALL_H_
...
/**
 * Declaration NetworkManagementModifyNodeCall
 */
class NetworkManagementModifyNodeCall : public CmdData {
public:
  /**
   ...
   */
  bool operator==(const NetworkManagementModifyNodeCall &c_classObject) const;
...
//! typedef for non-const smart pointer type NetworkManagementModifyNodeCall
using NetworkManagementModifyNodeCallPtr =
    std::shared_ptr<NetworkManagementModifyNodeCall>;

//! typedef for const type NetworkManagementModifyNodeCall
using NetworkManagementModifyNodeCallConst =
    const NetworkManagementModifyNodeCall;

//! typedef for const type NetworkManagementModifyNodeCall
using NetworkManagementModifyNodeCallConstPtr =
    std::shared_ptr<NetworkManagementModifyNodeCallConst>;
...
#endif // KEO_DATAGRAM_CORE_NETWORKMANAGEMENTMODIFYNODECALL_H_