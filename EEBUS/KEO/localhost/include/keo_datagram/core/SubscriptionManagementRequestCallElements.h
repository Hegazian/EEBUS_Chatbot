...
#ifndef KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTREQUESTCALLELEMENTS_H_
#define KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTREQUESTCALLELEMENTS_H_
...
/**
 * Declaration SubscriptionManagementRequestCallElements
 */
class SubscriptionManagementRequestCallElements : public DataElements {
public:
  /**
...
//! SubscriptionManagementRequestCallElements
using SubscriptionManagementRequestCallElementsPtr =
    std::shared_ptr<SubscriptionManagementRequestCallElements>;

//! typedef for const type SubscriptionManagementRequestCallElements
using SubscriptionManagementRequestCallElementsConst =
    const SubscriptionManagementRequestCallElements;

//! typedef for const type SubscriptionManagementRequestCallElements
using SubscriptionManagementRequestCallElementsConstPtr =
    std::shared_ptr<SubscriptionManagementRequestCallElementsConst>;
...
#endif // KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTREQUESTCALLELEMENTS_H_