...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTSCHEDULELISTDATASELECTORS_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTSCHEDULELISTDATASELECTORS_H_
...
/**
 * Declaration PowerTimeSlotScheduleListDataSelectors
 */
class PowerTimeSlotScheduleListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  PowerTimeSlotScheduleListDataSelectors(const xs_unsignedInt &c_sequenceId,
                                         const xs_unsignedInt &c_slotNumber);
   ...
   */
  bool selects(const PowerTimeSlotScheduleData &data) const;
...
//! PowerTimeSlotScheduleListDataSelectors
using PowerTimeSlotScheduleListDataSelectorsPtr =
    std::shared_ptr<PowerTimeSlotScheduleListDataSelectors>;

//! typedef for const type PowerTimeSlotScheduleListDataSelectors
using PowerTimeSlotScheduleListDataSelectorsConst =
    const PowerTimeSlotScheduleListDataSelectors;

//! typedef for const type PowerTimeSlotScheduleListDataSelectors
using PowerTimeSlotScheduleListDataSelectorsConstPtr =
    std::shared_ptr<PowerTimeSlotScheduleListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTSCHEDULELISTDATASELECTORS_H_