...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESTATE_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESTATE_H_
...
/**
 * Declaration PowerSequenceState
 */
class PowerSequenceState : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 8;

  //! Enumeration PowerSequenceState::Value
  enum class Value {
    UNDEFINED__ = -1,
    RUNNING,
    PAUSED,
   ...
   */
  PowerSequenceState(PowerSequenceState::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  PowerSequenceState(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static PowerSequenceState fromString(const std::string &c_text);
   ...
   */
  PowerSequenceState::Value getValue() const;
   ...
   * @return enumeration value
   */
  PowerSequenceState::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const PowerSequenceState &other) const;
...
private:
  ...
  PowerSequenceState::Value m_data;
...
/**
 * \deprecated Use PowerSequenceState instead.
 */
using PowerSequenceStateStruct = PowerSequenceState;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESTATE_H_