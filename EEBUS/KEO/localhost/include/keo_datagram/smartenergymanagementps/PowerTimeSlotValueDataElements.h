...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTVALUEDATAELEMENTS_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTVALUEDATAELEMENTS_H_
...
/**
 * Declaration PowerTimeSlotValueDataElements
 */
class PowerTimeSlotValueDataElements : public DataElements {
public:
  /**
   ...
   */
  bool operator==(const PowerTimeSlotValueDataElements &c_classObject) const;
...
//! typedef for non-const smart pointer type PowerTimeSlotValueDataElements
using PowerTimeSlotValueDataElementsPtr =
    std::shared_ptr<PowerTimeSlotValueDataElements>;

//! typedef for const type PowerTimeSlotValueDataElements
using PowerTimeSlotValueDataElementsConst =
    const PowerTimeSlotValueDataElements;

//! typedef for const type PowerTimeSlotValueDataElements
using PowerTimeSlotValueDataElementsConstPtr =
    std::shared_ptr<PowerTimeSlotValueDataElementsConst>;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTVALUEDATAELEMENTS_H_