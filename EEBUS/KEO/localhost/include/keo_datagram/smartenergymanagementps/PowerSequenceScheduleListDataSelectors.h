...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESCHEDULELISTDATASELECTORS_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESCHEDULELISTDATASELECTORS_H_
...
/**
 * Declaration PowerSequenceScheduleListDataSelectors
 */
class PowerSequenceScheduleListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit PowerSequenceScheduleListDataSelectors(
   ...
   */
  bool selects(const PowerSequenceScheduleData &data) const;
...
//! PowerSequenceScheduleListDataSelectors
using PowerSequenceScheduleListDataSelectorsPtr =
    std::shared_ptr<PowerSequenceScheduleListDataSelectors>;

//! typedef for const type PowerSequenceScheduleListDataSelectors
using PowerSequenceScheduleListDataSelectorsConst =
    const PowerSequenceScheduleListDataSelectors;

//! typedef for const type PowerSequenceScheduleListDataSelectors
using PowerSequenceScheduleListDataSelectorsConstPtr =
    std::shared_ptr<PowerSequenceScheduleListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESCHEDULELISTDATASELECTORS_H_