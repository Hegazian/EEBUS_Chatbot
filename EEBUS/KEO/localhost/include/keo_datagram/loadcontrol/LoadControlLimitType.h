...
#ifndef KEO_DATAGRAM_LOADCONTROL_LOADCONTROLLIMITTYPE_H_
#define KEO_DATAGRAM_LOADCONTROL_LOADCONTROLLIMITTYPE_H_
...
/**
 * Declaration LoadControlLimitType
 */
class LoadControlLimitType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 2;

  //! Enumeration LoadControlLimitType::Value
  enum class Value { UNDEFINED__ = -1, MIN_VALUE_LIMIT, MAX_VALUE_LIMIT };
   ...
   */
  LoadControlLimitType(LoadControlLimitType::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  LoadControlLimitType(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static LoadControlLimitType fromString(const std::string &c_text);
   ...
   */
  LoadControlLimitType::Value getValue() const;
   ...
   * @return enumeration value
   */
  LoadControlLimitType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const LoadControlLimitType &other) const;
...
private:
  ...
  LoadControlLimitType::Value m_data;
...
/**
 * \deprecated Use LoadControlLimitType instead.
 */
using LoadControlLimitTypeStruct = LoadControlLimitType;
...
#endif // KEO_DATAGRAM_LOADCONTROL_LOADCONTROLLIMITTYPE_H_