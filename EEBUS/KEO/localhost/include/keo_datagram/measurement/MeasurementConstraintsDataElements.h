...
#ifndef KEO_DATAGRAM_MEASUREMENT_MEASUREMENTCONSTRAINTSDATAELEMENTS_H_
#define KEO_DATAGRAM_MEASUREMENT_MEASUREMENTCONSTRAINTSDATAELEMENTS_H_
...
/**
 * Declaration MeasurementConstraintsDataElements
 */
class MeasurementConstraintsDataElements : public DataElements {
public:
  /**
...
//! typedef for non-const smart pointer type MeasurementConstraintsDataElements
using MeasurementConstraintsDataElementsPtr =
    std::shared_ptr<MeasurementConstraintsDataElements>;

//! typedef for const type MeasurementConstraintsDataElements
using MeasurementConstraintsDataElementsConst =
    const MeasurementConstraintsDataElements;

//! typedef for const type MeasurementConstraintsDataElements
using MeasurementConstraintsDataElementsConstPtr =
    std::shared_ptr<MeasurementConstraintsDataElementsConst>;
...
#endif // KEO_DATAGRAM_MEASUREMENT_MEASUREMENTCONSTRAINTSDATAELEMENTS_H_