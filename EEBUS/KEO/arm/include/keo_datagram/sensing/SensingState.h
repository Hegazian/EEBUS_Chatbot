...
#ifndef KEO_DATAGRAM_SENSING_SENSINGSTATE_H_
#define KEO_DATAGRAM_SENSING_SENSINGSTATE_H_
...
/**
 * Declaration SensingState
 */
class SensingState : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 36;

  //! Enumeration SensingState::Value
  enum class Value {
    UNDEFINED__ = -1,
    ON,
    OFF,
    ...
    LEVEL_ABSOLUTE,
    LEVEL_RELATIVE,
    LEVEL_PERCENTAGE_ABSOLUTE,
    LEVEL_PERCENTAGE_RELATIVE,
    PRESSED,
    LONG_PRESSED,
    RELEASED,
    CHANGED,
   ...
   */
  SensingState::Value getValue() const;
   ...
   * @return enumeration value
   */
  SensingState::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const SensingState &other) const;
...
/**
 * \deprecated Use SensingState instead.
 */
using SensingStateStruct = SensingState;
...
#endif // KEO_DATAGRAM_SENSING_SENSINGSTATE_H_