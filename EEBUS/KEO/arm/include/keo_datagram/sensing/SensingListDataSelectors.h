...
#ifndef KEO_DATAGRAM_SENSING_SENSINGLISTDATASELECTORS_H_
#define KEO_DATAGRAM_SENSING_SENSINGLISTDATASELECTORS_H_
...
/**
 * Declaration SensingListDataSelectors
 */
class SensingListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit SensingListDataSelectors(
   ...
   */
  bool operator==(const SensingListDataSelectors &c_classObject) const;
   ...
   */
  bool selects(const SensingData &data) const;
...
//! typedef for non-const smart pointer type SensingListDataSelectors
using SensingListDataSelectorsPtr = std::shared_ptr<SensingListDataSelectors>;

//! typedef for const type SensingListDataSelectors
using SensingListDataSelectorsConst = const SensingListDataSelectors;

//! typedef for const type SensingListDataSelectors
using SensingListDataSelectorsConstPtr =
    std::shared_ptr<SensingListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_SENSING_SENSINGLISTDATASELECTORS_H_