...
#ifndef KEO_DATAGRAM_SETPOINT_SETPOINTCONSTRAINTSLISTDATASELECTORS_H_
#define KEO_DATAGRAM_SETPOINT_SETPOINTCONSTRAINTSLISTDATASELECTORS_H_
...
/**
 * Declaration SetpointConstraintsListDataSelectors
 */
class SetpointConstraintsListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit SetpointConstraintsListDataSelectors(
   ...
   */
  bool selects(const SetpointConstraintsData &data) const;
...
//! SetpointConstraintsListDataSelectors
using SetpointConstraintsListDataSelectorsPtr =
    std::shared_ptr<SetpointConstraintsListDataSelectors>;

//! typedef for const type SetpointConstraintsListDataSelectors
using SetpointConstraintsListDataSelectorsConst =
    const SetpointConstraintsListDataSelectors;

//! typedef for const type SetpointConstraintsListDataSelectors
using SetpointConstraintsListDataSelectorsConstPtr =
    std::shared_ptr<SetpointConstraintsListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_SETPOINT_SETPOINTCONSTRAINTSLISTDATASELECTORS_H_