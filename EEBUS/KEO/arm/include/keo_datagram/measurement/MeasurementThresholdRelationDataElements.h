...
#ifndef KEO_DATAGRAM_MEASUREMENT_MEASUREMENTTHRESHOLDRELATIONDATAELEMENTS_H_
#define KEO_DATAGRAM_MEASUREMENT_MEASUREMENTTHRESHOLDRELATIONDATAELEMENTS_H_
...
/**
 * Declaration MeasurementThresholdRelationDataElements
 */
class MeasurementThresholdRelationDataElements : public DataElements {
public:
  /**
   ...
   * @param c_measurementIdIsSet the member to set
...
//! MeasurementThresholdRelationDataElements
using MeasurementThresholdRelationDataElementsPtr =
    std::shared_ptr<MeasurementThresholdRelationDataElements>;

//! typedef for const type MeasurementThresholdRelationDataElements
using MeasurementThresholdRelationDataElementsConst =
    const MeasurementThresholdRelationDataElements;

//! typedef for const type MeasurementThresholdRelationDataElements
using MeasurementThresholdRelationDataElementsConstPtr =
    std::shared_ptr<MeasurementThresholdRelationDataElementsConst>;
...
#endif // KEO_DATAGRAM_MEASUREMENT_MEASUREMENTTHRESHOLDRELATIONDATAELEMENTS_H_