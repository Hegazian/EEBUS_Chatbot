...
#ifndef KEO_DATAGRAM_MEASUREMENT_MEASUREMENTVALUETENDENCY_H_
#define KEO_DATAGRAM_MEASUREMENT_MEASUREMENTVALUETENDENCY_H_
...
/**
 * Declaration MeasurementValueTendency
 */
class MeasurementValueTendency : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 3;

  //! Enumeration MeasurementValueTendency::Value
  enum class Value { UNDEFINED__ = -1, RISING, STABLE, FALLING };
   ...
   */
  MeasurementValueTendency(MeasurementValueTendency::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  MeasurementValueTendency(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static MeasurementValueTendency fromString(const std::string &c_text);
   ...
   */
  MeasurementValueTendency::Value getValue() const;
   ...
   * @return enumeration value
   */
  MeasurementValueTendency::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const MeasurementValueTendency &other) const;
...
private:
  ...
  MeasurementValueTendency::Value m_data;
...
/**
 * \deprecated Use MeasurementValueTendency instead.
 */
using MeasurementValueTendencyStruct = MeasurementValueTendency;
...
#endif // KEO_DATAGRAM_MEASUREMENT_MEASUREMENTVALUETENDENCY_H_