...
#ifndef KEO_DATAGRAM_TIMETABLE_TIMETABLECONSTRAINTSLISTDATASELECTORS_H_
#define KEO_DATAGRAM_TIMETABLE_TIMETABLECONSTRAINTSLISTDATASELECTORS_H_
...
/**
 * Declaration TimeTableConstraintsListDataSelectors
 */
class TimeTableConstraintsListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit TimeTableConstraintsListDataSelectors(
   ...
   */
  bool selects(const TimeTableConstraintsData &data) const;
...
//! TimeTableConstraintsListDataSelectors
using TimeTableConstraintsListDataSelectorsPtr =
    std::shared_ptr<TimeTableConstraintsListDataSelectors>;

//! typedef for const type TimeTableConstraintsListDataSelectors
using TimeTableConstraintsListDataSelectorsConst =
    const TimeTableConstraintsListDataSelectors;

//! typedef for const type TimeTableConstraintsListDataSelectors
using TimeTableConstraintsListDataSelectorsConstPtr =
    std::shared_ptr<TimeTableConstraintsListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_TIMETABLE_TIMETABLECONSTRAINTSLISTDATASELECTORS_H_