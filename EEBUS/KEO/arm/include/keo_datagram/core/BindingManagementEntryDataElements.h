...
#ifndef KEO_DATAGRAM_CORE_BINDINGMANAGEMENTENTRYDATAELEMENTS_H_
#define KEO_DATAGRAM_CORE_BINDINGMANAGEMENTENTRYDATAELEMENTS_H_
...
/**
 * Declaration BindingManagementEntryDataElements
 */
class BindingManagementEntryDataElements : public DataElements {
public:
  /**
...
//! typedef for non-const smart pointer type BindingManagementEntryDataElements
using BindingManagementEntryDataElementsPtr =
    std::shared_ptr<BindingManagementEntryDataElements>;

//! typedef for const type BindingManagementEntryDataElements
using BindingManagementEntryDataElementsConst =
    const BindingManagementEntryDataElements;

//! typedef for const type BindingManagementEntryDataElements
using BindingManagementEntryDataElementsConstPtr =
    std::shared_ptr<BindingManagementEntryDataElementsConst>;
...
#endif // KEO_DATAGRAM_CORE_BINDINGMANAGEMENTENTRYDATAELEMENTS_H_