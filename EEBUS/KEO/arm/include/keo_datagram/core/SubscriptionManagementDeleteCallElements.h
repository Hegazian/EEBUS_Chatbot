...
#ifndef KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTDELETECALLELEMENTS_H_
#define KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTDELETECALLELEMENTS_H_
...
/**
 * Declaration SubscriptionManagementDeleteCallElements
 */
class SubscriptionManagementDeleteCallElements : public DataElements {
public:
  /**
   ...
   * @param c_subscriptionIdIsSet the member to set
...
//! SubscriptionManagementDeleteCallElements
using SubscriptionManagementDeleteCallElementsPtr =
    std::shared_ptr<SubscriptionManagementDeleteCallElements>;

//! typedef for const type SubscriptionManagementDeleteCallElements
using SubscriptionManagementDeleteCallElementsConst =
    const SubscriptionManagementDeleteCallElements;

//! typedef for const type SubscriptionManagementDeleteCallElements
using SubscriptionManagementDeleteCallElementsConstPtr =
    std::shared_ptr<SubscriptionManagementDeleteCallElementsConst>;
...
#endif // KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTDELETECALLELEMENTS_H_