...
#ifndef KEO_DATAGRAM_CORE_USECASEINFORMATIONDATAELEMENTS_H_
#define KEO_DATAGRAM_CORE_USECASEINFORMATIONDATAELEMENTS_H_
...
/**
 * Declaration UseCaseInformationDataElements
 */
class UseCaseInformationDataElements : public DataElements {
public:
  /**
   ...
   * @param c_actorIsSet the member to set
   ...
   */
  bool operator==(const UseCaseInformationDataElements &c_classObject) const;
   ...
   */
  void setAddress(const FeatureAddressElements &c_address);

  /**
   * Returns const reference to member Address.
   * @return const reference to member address
   */
  const FeatureAddressElements &getAddress() const;
   ...
   */
  void setUseCaseSupport(const UseCaseSupportElements &c_useCaseSupport);

  /**
   * Returns const reference to member UseCaseSupport.
   * @return const reference to member useCaseSupport
   */
  const UseCaseSupportElements &getUseCaseSupport() const;
...
private:
  ...
  bool m_addressIsSet;
  FeatureAddressElements m_address;

  // ElementTag
  bool m_actorIsSet;

  bool m_useCaseSupportIsSet;
  UseCaseSupportElements m_useCaseSupport;
};

//! typedef for non-const smart pointer type UseCaseInformationDataElements
using UseCaseInformationDataElementsPtr =
    std::shared_ptr<UseCaseInformationDataElements>;

//! typedef for const type UseCaseInformationDataElements
using UseCaseInformationDataElementsConst =
    const UseCaseInformationDataElements;

//! typedef for const type UseCaseInformationDataElements
using UseCaseInformationDataElementsConstPtr =
    std::shared_ptr<UseCaseInformationDataElementsConst>;
...
#endif // KEO_DATAGRAM_CORE_USECASEINFORMATIONDATAELEMENTS_H_