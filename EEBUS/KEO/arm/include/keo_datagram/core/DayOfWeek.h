...
#ifndef KEO_DATAGRAM_CORE_DAYOFWEEK_H_
#define KEO_DATAGRAM_CORE_DAYOFWEEK_H_
...
/**
 * Declaration DayOfWeek
 */
class DayOfWeek : public SpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 7;

  //! Enumeration DayOfWeek::Value
  enum class Value {
    UNDEFINED__ = -1,
    MONDAY,
    TUESDAY,
  ...
  */
  DayOfWeek(DayOfWeek::Value c_data);

  /**
  * Construct from string.
  * @param c_text Classifier string
  */
  explicit DayOfWeek(const std::string &c_text);
   ...
   */
  static DayOfWeek::Value fromString(const std::string &c_text);
   ...
   */
  DayOfWeek::Value getValue() const;
   ...
   */
  bool operator==(const DayOfWeek &c_enumCmdClassifier) const;
...
#endif // KEO_DATAGRAM_CORE_DAYOFWEEK_H_