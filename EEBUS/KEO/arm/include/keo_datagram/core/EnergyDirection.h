...
#ifndef KEO_DATAGRAM_CORE_ENERGYDIRECTION_H_
#define KEO_DATAGRAM_CORE_ENERGYDIRECTION_H_
...
/**
 * Declaration EnergyDirection
 */
class EnergyDirection : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 2;

  //! Enumeration EnergyDirection::Value
  enum class Value { UNDEFINED__ = -1, CONSUME, PRODUCE };
   ...
   */
  EnergyDirection::Value getValue() const;
   ...
   * @return enumeration value
   */
  EnergyDirection::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const EnergyDirection &other) const;
...
/**
 * \deprecated Use EnergyDirection instead.
 */
using EnergyDirectionStruct = EnergyDirection;
...
#endif // KEO_DATAGRAM_CORE_ENERGYDIRECTION_H_