...
#ifndef KEO_DATAGRAM_CORE_USECASESUPPORT_H_
#define KEO_DATAGRAM_CORE_USECASESUPPORT_H_
...
/**
 * Declaration UseCaseSupport
 */
class UseCaseSupport : public KeoJsonTransformable {
public:
  /**
   ...
   */
  bool operator==(const UseCaseSupport &c_classObject) const;
   ...
   * @param c_useCaseAvailable Value to set
   */
  void setUseCaseAvailable(const xs_boolean &c_useCaseAvailable);

  /**
   * Returns const reference to member UseCaseAvailable.
   * @return const reference to member useCaseAvailable
   */
  const xs_boolean &getUseCaseAvailable() const;
   ...
   */
  void setScenarioSupport(const std::vector<xs_unsignedInt> &c_scenarioSupport);

  /**
   * Returns const reference to member ScenarioSupport.
   * @return const reference to member scenarioSupport
   */
  const std::vector<xs_unsignedInt> &getScenarioSupport() const;
...
private:
  ...
  xs_boolean m_useCaseAvailable;

  bool m_scenarioSupportIsSet;
  std::vector<xs_unsignedInt> m_scenarioSupport;
};

//! typedef for non-const smart pointer type UseCaseSupport
using UseCaseSupportPtr = std::shared_ptr<UseCaseSupport>;

//! typedef for const type UseCaseSupport
using UseCaseSupportConst = const UseCaseSupport;

//! typedef for const type UseCaseSupport
using UseCaseSupportConstPtr = std::shared_ptr<UseCaseSupportConst>;
...
#endif // KEO_DATAGRAM_CORE_USECASESUPPORT_H_