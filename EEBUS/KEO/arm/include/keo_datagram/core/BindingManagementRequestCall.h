...
#ifndef KEO_DATAGRAM_CORE_BINDINGMANAGEMENTREQUESTCALL_H_
#define KEO_DATAGRAM_CORE_BINDINGMANAGEMENTREQUESTCALL_H_
...
/**
 * Declaration BindingManagementRequestCall
 */
class BindingManagementRequestCall : public CmdData {
public:
  /**
   ...
   */
  BindingManagementRequestCall(const FeatureAddress &c_clientAddress,
   ...
   */
  bool operator==(const BindingManagementRequestCall &c_classObject) const;
...
//! typedef for non-const smart pointer type BindingManagementRequestCall
using BindingManagementRequestCallPtr =
    std::shared_ptr<BindingManagementRequestCall>;

//! typedef for const type BindingManagementRequestCall
using BindingManagementRequestCallConst = const BindingManagementRequestCall;

//! typedef for const type BindingManagementRequestCall
using BindingManagementRequestCallConstPtr =
    std::shared_ptr<BindingManagementRequestCallConst>;
...
#endif // KEO_DATAGRAM_CORE_BINDINGMANAGEMENTREQUESTCALL_H_