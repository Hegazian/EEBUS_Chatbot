...
#ifndef KEO_DATAGRAM_CORE_ENERGYMODE_H_
#define KEO_DATAGRAM_CORE_ENERGYMODE_H_
...
/**
 * Declaration EnergyMode
 */
class EnergyMode : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 4;

  //! Enumeration EnergyMode::Value
  enum class Value { UNDEFINED__ = -1, CONSUME, PRODUCE, IDLE, AUTO };
   ...
   */
  EnergyMode::Value getValue() const;
   ...
   * @return enumeration value
   */
  EnergyMode::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const EnergyMode &other) const;
...
/**
 * \deprecated Use EnergyMode instead.
 */
using EnergyModeStruct = EnergyMode;
...
#endif // KEO_DATAGRAM_CORE_ENERGYMODE_H_