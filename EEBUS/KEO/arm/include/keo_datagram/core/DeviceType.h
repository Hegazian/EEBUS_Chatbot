...
#ifndef KEO_DATAGRAM_CORE_DEVICETYPE_H_
#define KEO_DATAGRAM_CORE_DEVICETYPE_H_
...
public:
   ...
   */
  DeviceType::Value getValue() const;
   ...
   * @return enumeration value
   */
  DeviceType::Value getData() const;
 ...
 */
using DeviceTypeStruct = DeviceType;
...
#endif // KEO_DATAGRAM_CORE_DEVICETYPE_H_