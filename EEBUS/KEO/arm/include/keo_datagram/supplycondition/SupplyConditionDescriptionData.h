...
#ifndef KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONDATA_H_
#define KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONDATA_H_
...
/**
 * Declaration SupplyConditionDescriptionData
 */
class SupplyConditionDescriptionData : public KeoJsonTransformable {
public:
  /**
   ...
   */
  bool operator==(const SupplyConditionDescriptionData &c_classObject) const;
   ...
   */
  SupplyConditionDescriptionData
  reduce(const SupplyConditionDescriptionDataElements &elements) const;
...
//! typedef for non-const smart pointer type SupplyConditionDescriptionData
using SupplyConditionDescriptionDataPtr =
    std::shared_ptr<SupplyConditionDescriptionData>;

//! typedef for const type SupplyConditionDescriptionData
using SupplyConditionDescriptionDataConst =
    const SupplyConditionDescriptionData;

//! typedef for const type SupplyConditionDescriptionData
using SupplyConditionDescriptionDataConstPtr =
    std::shared_ptr<SupplyConditionDescriptionDataConst>;
...
#endif // KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONDATA_H_