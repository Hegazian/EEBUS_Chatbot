...
#ifndef KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONDATAELEMENTS_H_
#define KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONDATAELEMENTS_H_
...
/**
 * Declaration SupplyConditionDescriptionDataElements
 */
class SupplyConditionDescriptionDataElements : public DataElements {
public:
  /**
...
//! SupplyConditionDescriptionDataElements
using SupplyConditionDescriptionDataElementsPtr =
    std::shared_ptr<SupplyConditionDescriptionDataElements>;

//! typedef for const type SupplyConditionDescriptionDataElements
using SupplyConditionDescriptionDataElementsConst =
    const SupplyConditionDescriptionDataElements;

//! typedef for const type SupplyConditionDescriptionDataElements
using SupplyConditionDescriptionDataElementsConstPtr =
    std::shared_ptr<SupplyConditionDescriptionDataElementsConst>;
...
#endif // KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONDATAELEMENTS_H_