...
#ifndef KEO_DATAGRAM_INCENTIVETABLE_TARIFFTIERRELATIONLISTDATASELECTORS_H_
#define KEO_DATAGRAM_INCENTIVETABLE_TARIFFTIERRELATIONLISTDATASELECTORS_H_
...
/**
 * Declaration TariffTierRelationListDataSelectors
 */
class TariffTierRelationListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  TariffTierRelationListDataSelectors(const xs_unsignedInt &c_tariffId,
   ...
   */
  bool selects(const TariffTierRelationData &data) const;
...
//! typedef for non-const smart pointer type TariffTierRelationListDataSelectors
using TariffTierRelationListDataSelectorsPtr =
    std::shared_ptr<TariffTierRelationListDataSelectors>;

//! typedef for const type TariffTierRelationListDataSelectors
using TariffTierRelationListDataSelectorsConst =
    const TariffTierRelationListDataSelectors;

//! typedef for const type TariffTierRelationListDataSelectors
using TariffTierRelationListDataSelectorsConstPtr =
    std::shared_ptr<TariffTierRelationListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_INCENTIVETABLE_TARIFFTIERRELATIONLISTDATASELECTORS_H_