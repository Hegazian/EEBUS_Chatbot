...
#ifndef KEO_DATAGRAM_ACTUATOR_ACTUATORLEVELFCT_H_
#define KEO_DATAGRAM_ACTUATOR_ACTUATORLEVELFCT_H_
...
/**
 * Declaration ActuatorLevelFct
 */
class ActuatorLevelFct : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 8;

  //! Enumeration ActuatorLevelFct::Value
  enum class Value {
    UNDEFINED__ = -1,
    START,
    UP,
   ...
   */
  ActuatorLevelFct::Value getValue() const;
   ...
   * @return enumeration value
   */
  ActuatorLevelFct::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const ActuatorLevelFct &other) const;
...
/**
 * \deprecated Use ActuatorLevelFct instead.
 */
using ActuatorLevelFctStruct = ActuatorLevelFct;
...
#endif // KEO_DATAGRAM_ACTUATOR_ACTUATORLEVELFCT_H_