...
#ifndef KEO_DATAGRAM_ACTUATOR_ACTUATORSWITCHFCT_H_
#define KEO_DATAGRAM_ACTUATOR_ACTUATORSWITCHFCT_H_
...
/**
 * Declaration ActuatorSwitchFct
 */
class ActuatorSwitchFct : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 3;

  //! Enumeration ActuatorSwitchFct::Value
  enum class Value { UNDEFINED__ = -1, ON, OFF, TOGGLE };
   ...
   */
  ActuatorSwitchFct::Value getValue() const;
   ...
   * @return enumeration value
   */
  ActuatorSwitchFct::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const ActuatorSwitchFct &other) const;
...
private:
  ...
  ActuatorSwitchFct::Value m_data;
...
/**
 * \deprecated Use ActuatorSwitchFct instead.
 */
using ActuatorSwitchFctStruct = ActuatorSwitchFct;
...
#endif // KEO_DATAGRAM_ACTUATOR_ACTUATORSWITCHFCT_H_