...
#ifndef KEO_DATAGRAM_ACTUATOR_ACTUATORSWITCHDESCRIPTIONDATA_H_
#define KEO_DATAGRAM_ACTUATOR_ACTUATORSWITCHDESCRIPTIONDATA_H_
...
/**
 * Declaration ActuatorSwitchDescriptionData
 */
class ActuatorSwitchDescriptionData : public CmdData {
public:
  /**
   ...
   */
  ActuatorSwitchDescriptionData(const xs_string &c_label,
   ...
   */
  bool operator==(const ActuatorSwitchDescriptionData &c_classObject) const;
...
//! typedef for non-const smart pointer type ActuatorSwitchDescriptionData
using ActuatorSwitchDescriptionDataPtr =
    std::shared_ptr<ActuatorSwitchDescriptionData>;

//! typedef for const type ActuatorSwitchDescriptionData
using ActuatorSwitchDescriptionDataConst = const ActuatorSwitchDescriptionData;

//! typedef for const type ActuatorSwitchDescriptionData
using ActuatorSwitchDescriptionDataConstPtr =
    std::shared_ptr<ActuatorSwitchDescriptionDataConst>;
...
#endif // KEO_DATAGRAM_ACTUATOR_ACTUATORSWITCHDESCRIPTIONDATA_H_