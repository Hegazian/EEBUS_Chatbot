...
#ifndef KEO_DATAGRAM_ACTUATOR_ACTUATORLEVELDATAELEMENTS_H_
#define KEO_DATAGRAM_ACTUATOR_ACTUATORLEVELDATAELEMENTS_H_
...
/**
 * Declaration ActuatorLevelDataElements
 */
class ActuatorLevelDataElements : public DataElements {
public:
  /**
   ...
   */
  ActuatorLevelDataElements(xs_boolean c_functionIsSet,
   ...
   */
  bool operator==(const ActuatorLevelDataElements &c_classObject) const;
...
//! typedef for non-const smart pointer type ActuatorLevelDataElements
using ActuatorLevelDataElementsPtr = std::shared_ptr<ActuatorLevelDataElements>;

//! typedef for const type ActuatorLevelDataElements
using ActuatorLevelDataElementsConst = const ActuatorLevelDataElements;

//! typedef for const type ActuatorLevelDataElements
using ActuatorLevelDataElementsConstPtr =
    std::shared_ptr<ActuatorLevelDataElementsConst>;
...
#endif // KEO_DATAGRAM_ACTUATOR_ACTUATORLEVELDATAELEMENTS_H_