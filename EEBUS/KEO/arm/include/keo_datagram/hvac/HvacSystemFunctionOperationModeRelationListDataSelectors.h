...
#ifndef KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONOPERATIONMODERELATIONLISTDATASELECTORS_H_
#define KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONOPERATIONMODERELATIONLISTDATASELECTORS_H_
...
/**
 * Declaration HvacSystemFunctionOperationModeRelationListDataSelectors
 */
class HvacSystemFunctionOperationModeRelationListDataSelectors
...
public:
   ...
   */
  explicit HvacSystemFunctionOperationModeRelationListDataSelectors(
   ...
   */
  bool operator==(const HvacSystemFunctionOperationModeRelationListDataSelectors
                      &c_classObject) const;
   ...
   */
  bool selects(const HvacSystemFunctionOperationModeRelationData &data) const;
...
//! HvacSystemFunctionOperationModeRelationListDataSelectors
using HvacSystemFunctionOperationModeRelationListDataSelectorsPtr =
    std::shared_ptr<HvacSystemFunctionOperationModeRelationListDataSelectors>;

//! typedef for const type
//! HvacSystemFunctionOperationModeRelationListDataSelectors
using HvacSystemFunctionOperationModeRelationListDataSelectorsConst =
    const HvacSystemFunctionOperationModeRelationListDataSelectors;

//! typedef for const type
//! HvacSystemFunctionOperationModeRelationListDataSelectors
using HvacSystemFunctionOperationModeRelationListDataSelectorsConstPtr =
    std::shared_ptr<
        HvacSystemFunctionOperationModeRelationListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONOPERATIONMODERELATIONLISTDATASELECTORS_H_