...
#ifndef KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONTYPE_H_
#define KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONTYPE_H_
...
/**
 * Declaration HvacSystemFunctionType
 */
class HvacSystemFunctionType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 4;

  //! Enumeration HvacSystemFunctionType::Value
  enum class Value { UNDEFINED__ = -1, HEATING, COOLING, VENTILATION, DHW };
   ...
   */
  HvacSystemFunctionType(HvacSystemFunctionType::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  HvacSystemFunctionType(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static HvacSystemFunctionType fromString(const std::string &c_text);
   ...
   */
  HvacSystemFunctionType::Value getValue() const;
   ...
   * @return enumeration value
   */
  HvacSystemFunctionType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const HvacSystemFunctionType &other) const;
...
private:
  ...
  HvacSystemFunctionType::Value m_data;
...
/**
 * \deprecated Use HvacSystemFunctionType instead.
 */
using HvacSystemFunctionTypeStruct = HvacSystemFunctionType;
...
#endif // KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONTYPE_H_