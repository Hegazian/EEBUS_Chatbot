...
#ifndef KEO_DATAGRAM_HVAC_HVACOVERRUNSTATUS_H_
#define KEO_DATAGRAM_HVAC_HVACOVERRUNSTATUS_H_
...
/**
 * Declaration HvacOverrunStatus
 */
class HvacOverrunStatus : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 4;

  //! Enumeration HvacOverrunStatus::Value
  enum class Value { UNDEFINED__ = -1, ACTIVE, RUNNING, FINISHED, INACTIVE };
   ...
   */
  HvacOverrunStatus::Value getValue() const;
   ...
   * @return enumeration value
   */
  HvacOverrunStatus::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const HvacOverrunStatus &other) const;
...
private:
  ...
  HvacOverrunStatus::Value m_data;
...
/**
 * \deprecated Use HvacOverrunStatus instead.
 */
using HvacOverrunStatusStruct = HvacOverrunStatus;
...
#endif // KEO_DATAGRAM_HVAC_HVACOVERRUNSTATUS_H_