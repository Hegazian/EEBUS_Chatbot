...
#ifndef KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONDATAELEMENTS_H_
#define KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONDATAELEMENTS_H_
...
/**
 * Declaration HvacSystemFunctionDataElements
 */
class HvacSystemFunctionDataElements : public DataElements {
public:
  /**
   ...
   */
  bool operator==(const HvacSystemFunctionDataElements &c_classObject) const;
   ...
   */
  void setCurrentOperationModeId();
   ...
   */
  void setIsSetpointIdChangeable();
...
//! typedef for non-const smart pointer type HvacSystemFunctionDataElements
using HvacSystemFunctionDataElementsPtr =
    std::shared_ptr<HvacSystemFunctionDataElements>;

//! typedef for const type HvacSystemFunctionDataElements
using HvacSystemFunctionDataElementsConst =
    const HvacSystemFunctionDataElements;

//! typedef for const type HvacSystemFunctionDataElements
using HvacSystemFunctionDataElementsConstPtr =
    std::shared_ptr<HvacSystemFunctionDataElementsConst>;
...
#endif // KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONDATAELEMENTS_H_