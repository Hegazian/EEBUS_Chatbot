...
#ifndef KEO_DATAGRAM_TASKMANAGEMENT_TASKMANAGEMENTJOBSTATE_H_
#define KEO_DATAGRAM_TASKMANAGEMENT_TASKMANAGEMENTJOBSTATE_H_
...
/**
 * Declaration TaskManagementJobState
 */
class TaskManagementJobState : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 16;

  //! Enumeration TaskManagementJobState::Value
  enum class Value {
    UNDEFINED__ = -1,
    ACTIVE,
    COMPLETED,
   ...
   */
  TaskManagementJobState(TaskManagementJobState::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  TaskManagementJobState(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static TaskManagementJobState fromString(const std::string &c_text);
   ...
   */
  TaskManagementJobState::Value getValue() const;
   ...
   * @return enumeration value
   */
  TaskManagementJobState::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const TaskManagementJobState &other) const;
...
private:
  ...
  TaskManagementJobState::Value m_data;
...
/**
 * \deprecated Use TaskManagementJobState instead.
 */
using TaskManagementJobStateStruct = TaskManagementJobState;
...
#endif // KEO_DATAGRAM_TASKMANAGEMENT_TASKMANAGEMENTJOBSTATE_H_