...
#ifndef KEO_DATAGRAM_MESSAGING_MESSAGINGTYPE_H_
#define KEO_DATAGRAM_MESSAGING_MESSAGINGTYPE_H_
...
/**
 * Declaration MessagingType
 */
class MessagingType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 6;

  //! Enumeration MessagingType::Value
  enum class Value {
    UNDEFINED__ = -1,
    LOGGING,
    INFORMATION,
   ...
   */
  MessagingType::Value getValue() const;
   ...
   * @return enumeration value
   */
  MessagingType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const MessagingType &other) const;
...
/**
 * \deprecated Use MessagingType instead.
 */
using MessagingTypeStruct = MessagingType;
...
#endif // KEO_DATAGRAM_MESSAGING_MESSAGINGTYPE_H_