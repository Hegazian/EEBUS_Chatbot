...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESTATELISTDATASELECTORS_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESTATELISTDATASELECTORS_H_
...
/**
 * Declaration PowerSequenceStateListDataSelectors
 */
class PowerSequenceStateListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit PowerSequenceStateListDataSelectors(
   ...
   */
  bool selects(const PowerSequenceStateData &data) const;
...
//! typedef for non-const smart pointer type PowerSequenceStateListDataSelectors
using PowerSequenceStateListDataSelectorsPtr =
    std::shared_ptr<PowerSequenceStateListDataSelectors>;

//! typedef for const type PowerSequenceStateListDataSelectors
using PowerSequenceStateListDataSelectorsConst =
    const PowerSequenceStateListDataSelectors;

//! typedef for const type PowerSequenceStateListDataSelectors
using PowerSequenceStateListDataSelectorsConstPtr =
    std::shared_ptr<PowerSequenceStateListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCESTATELISTDATASELECTORS_H_