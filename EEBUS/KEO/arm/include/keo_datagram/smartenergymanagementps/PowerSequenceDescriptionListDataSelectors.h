...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCEDESCRIPTIONLISTDATASELECTORS_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCEDESCRIPTIONLISTDATASELECTORS_H_
...
/**
 * Declaration PowerSequenceDescriptionListDataSelectors
 */
class PowerSequenceDescriptionListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit PowerSequenceDescriptionListDataSelectors(
   ...
   */
  bool selects(const PowerSequenceDescriptionData &data) const;
...
//! PowerSequenceDescriptionListDataSelectors
using PowerSequenceDescriptionListDataSelectorsPtr =
    std::shared_ptr<PowerSequenceDescriptionListDataSelectors>;

//! typedef for const type PowerSequenceDescriptionListDataSelectors
using PowerSequenceDescriptionListDataSelectorsConst =
    const PowerSequenceDescriptionListDataSelectors;

//! typedef for const type PowerSequenceDescriptionListDataSelectors
using PowerSequenceDescriptionListDataSelectorsConstPtr =
    std::shared_ptr<PowerSequenceDescriptionListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCEDESCRIPTIONLISTDATASELECTORS_H_