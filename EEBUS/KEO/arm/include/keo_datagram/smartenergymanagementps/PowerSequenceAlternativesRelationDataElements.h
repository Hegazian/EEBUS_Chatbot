...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCEALTERNATIVESRELATIONDATAELEMENTS_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCEALTERNATIVESRELATIONDATAELEMENTS_H_
...
/**
 * Declaration PowerSequenceAlternativesRelationDataElements
 */
class PowerSequenceAlternativesRelationDataElements : public DataElements {
public:
  /**
...
//! PowerSequenceAlternativesRelationDataElements
using PowerSequenceAlternativesRelationDataElementsPtr =
    std::shared_ptr<PowerSequenceAlternativesRelationDataElements>;

//! typedef for const type PowerSequenceAlternativesRelationDataElements
using PowerSequenceAlternativesRelationDataElementsConst =
    const PowerSequenceAlternativesRelationDataElements;

//! typedef for const type PowerSequenceAlternativesRelationDataElements
using PowerSequenceAlternativesRelationDataElementsConstPtr =
    std::shared_ptr<PowerSequenceAlternativesRelationDataElementsConst>;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERSEQUENCEALTERNATIVESRELATIONDATAELEMENTS_H_