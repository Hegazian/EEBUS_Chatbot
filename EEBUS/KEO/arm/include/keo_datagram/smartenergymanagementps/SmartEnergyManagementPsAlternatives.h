...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_SMARTENERGYMANAGEMENTPSALTERNATIVES_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_SMARTENERGYMANAGEMENTPSALTERNATIVES_H_
...
/**
 * Declaration SmartEnergyManagementPsAlternatives
 */
class SmartEnergyManagementPsAlternatives : public KeoJsonTransformable {
public:
  /**
   ...
   */
  void
  setRelation(const SmartEnergyManagementPsAlternativesRelation &c_relation);

  /**
   * Returns const reference to member Relation.
   * @return const reference to member relation
   */
  const SmartEnergyManagementPsAlternativesRelation &getRelation() const;
...
private:
  ...
  SmartEnergyManagementPsAlternativesRelation m_relation;

  bool m_powerSequenceIsSet;
  std::vector<SmartEnergyManagementPsPowerSequence> m_powerSequence;
};

//! typedef for non-const smart pointer type SmartEnergyManagementPsAlternatives
using SmartEnergyManagementPsAlternativesPtr =
    std::shared_ptr<SmartEnergyManagementPsAlternatives>;

//! typedef for const type SmartEnergyManagementPsAlternatives
using SmartEnergyManagementPsAlternativesConst =
    const SmartEnergyManagementPsAlternatives;

//! typedef for const type SmartEnergyManagementPsAlternatives
using SmartEnergyManagementPsAlternativesConstPtr =
    std::shared_ptr<SmartEnergyManagementPsAlternativesConst>;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_SMARTENERGYMANAGEMENTPSALTERNATIVES_H_