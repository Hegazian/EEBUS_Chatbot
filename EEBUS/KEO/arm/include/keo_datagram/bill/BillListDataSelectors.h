...
#ifndef KEO_DATAGRAM_BILL_BILLLISTDATASELECTORS_H_
#define KEO_DATAGRAM_BILL_BILLLISTDATASELECTORS_H_
...
/**
 * Declaration BillListDataSelectors
 */
class BillListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  BillListDataSelectors(const xs_unsignedInt &c_billId,
   ...
   */
  bool operator==(const BillListDataSelectors &c_classObject) const;
   ...
   */
  bool selects(const BillData &data) const;
...
//! typedef for non-const smart pointer type BillListDataSelectors
using BillListDataSelectorsPtr = std::shared_ptr<BillListDataSelectors>;

//! typedef for const type BillListDataSelectors
using BillListDataSelectorsConst = const BillListDataSelectors;

//! typedef for const type BillListDataSelectors
using BillListDataSelectorsConstPtr =
    std::shared_ptr<BillListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_BILL_BILLLISTDATASELECTORS_H_