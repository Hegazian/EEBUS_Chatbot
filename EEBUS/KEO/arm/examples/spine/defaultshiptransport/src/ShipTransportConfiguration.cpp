 ...
 */
/**
 *     @brief      ShipTransportConfiguration class definition
 *
 *     @par        ShipStackConfiguration read and write the configuration
 *
...
keo_ship::ShipStackConfiguration ShipTransportConfiguration::getShipConfiguration() const
{
    DEBUG_FUNC();
