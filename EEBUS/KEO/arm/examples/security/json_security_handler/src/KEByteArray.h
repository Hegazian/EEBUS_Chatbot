...
#ifndef KEBYTEARRAY_H_
#define KEBYTEARRAY_H_
...
public:
    ...
    KEByteArray();
    /**
     * Initializes an instance of KEByteArray with binary content in s. std::string contains explicit size information
     * to it is not zero-terminated.
     * @param s
     */
    KEByteArray(const std::string& s);
    /**
     * Initializes an instance of KEByteArray with binary content. In this special case it is an ordinary C-String, zero-terminated.
     * @param s C-style string pointer
     */
    KEByteArray(const char* s);
    /**
     * Initializes an instance of KEByteArray with binary content.
     * @param s Pointer to the data
     * @param size Size of the data
     */
    KEByteArray(const char* s, size_t size);
    /**
     * Initializes an instance of KEByteArray from a vector of characters.
     * @param s character vector
     */
    KEByteArray(const std::vector<char>& s);
    /**
     * Initializes an instance of KEByteArray from a vector of unsigned characters.
     * @param s unsigned character vector
     */
    KEByteArray(const std::vector<unsigned char>& s);
    /**
     * Initializes an instance of KEByteArray with a sequence of a single byte.
     * @param size count of bytes to initialize
     * @param fillChar filling character (byte)
     */
    KEByteArray(size_t size, char fillChar);
     ...
     */
    static KEByteArray fromHex(const char* hexString);
     ...
     */
    static KEByteArray fromHex(const std::string& hexString);
     ...
     */
    bool equals(const KEByteArray& other) const;

    /**
     * @see equals(const KEByteArray &).
     * Compares to another instance of this class.
     * @param r other instance to compare
     * @return
     */
    bool operator==(const KEByteArray& r) const
    {
        return equals(r);
    }
     ...
     * @return
     */
    KEByteArray& operator=(const KEByteArray& other);
...
//! typedef for non-const smart pointer type KEByteArray
typedef std::shared_ptr<KEByteArray> KEByteArrayPtr;

//! typedef for const type KEByteArray
typedef const KEByteArray KEByteArrayConst;

//! typedef for const smart pointer type KEByteArray
typedef std::shared_ptr<KEByteArrayConst> KEByteArrayConstPtr;
