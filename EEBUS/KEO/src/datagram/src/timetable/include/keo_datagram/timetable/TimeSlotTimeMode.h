...
#ifndef KEO_DATAGRAM_TIMETABLE_TIMESLOTTIMEMODE_H_
#define KEO_DATAGRAM_TIMETABLE_TIMESLOTTIMEMODE_H_
...
/**
 * Declaration TimeSlotTimeMode
 */
class TimeSlotTimeMode : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 3;

  //! Enumeration TimeSlotTimeMode::Value
  enum class Value { UNDEFINED__ = -1, ABSOLUTE, RECURRING, BOTH };
   ...
   */
  TimeSlotTimeMode::Value getValue() const;
   ...
   * @return enumeration value
   */
  TimeSlotTimeMode::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const TimeSlotTimeMode &other) const;
...
/**
 * \deprecated Use TimeSlotTimeMode instead.
 */
using TimeSlotTimeModeStruct = TimeSlotTimeMode;
...
#endif // KEO_DATAGRAM_TIMETABLE_TIMESLOTTIMEMODE_H_