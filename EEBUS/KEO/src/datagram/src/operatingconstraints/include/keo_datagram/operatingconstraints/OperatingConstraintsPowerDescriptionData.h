...
#ifndef KEO_DATAGRAM_OPERATINGCONSTRAINTS_OPERATINGCONSTRAINTSPOWERDESCRIPTIONDATA_H_
#define KEO_DATAGRAM_OPERATINGCONSTRAINTS_OPERATINGCONSTRAINTSPOWERDESCRIPTIONDATA_H_
...
/**
 * Declaration OperatingConstraintsPowerDescriptionData
 */
class OperatingConstraintsPowerDescriptionData : public KeoJsonTransformable {
public:
  /**
...
//! OperatingConstraintsPowerDescriptionData
using OperatingConstraintsPowerDescriptionDataPtr =
    std::shared_ptr<OperatingConstraintsPowerDescriptionData>;

//! typedef for const type OperatingConstraintsPowerDescriptionData
using OperatingConstraintsPowerDescriptionDataConst =
    const OperatingConstraintsPowerDescriptionData;

//! typedef for const type OperatingConstraintsPowerDescriptionData
using OperatingConstraintsPowerDescriptionDataConstPtr =
    std::shared_ptr<OperatingConstraintsPowerDescriptionDataConst>;
...
#endif // KEO_DATAGRAM_OPERATINGCONSTRAINTS_OPERATINGCONSTRAINTSPOWERDESCRIPTIONDATA_H_