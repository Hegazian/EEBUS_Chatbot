...
#ifndef KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONLISTDATASELECTORS_H_
#define KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONLISTDATASELECTORS_H_
...
/**
 * Declaration SupplyConditionDescriptionListDataSelectors
 */
class SupplyConditionDescriptionListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit SupplyConditionDescriptionListDataSelectors(
   ...
   */
  bool selects(const SupplyConditionDescriptionData &data) const;
...
//! SupplyConditionDescriptionListDataSelectors
using SupplyConditionDescriptionListDataSelectorsPtr =
    std::shared_ptr<SupplyConditionDescriptionListDataSelectors>;

//! typedef for const type SupplyConditionDescriptionListDataSelectors
using SupplyConditionDescriptionListDataSelectorsConst =
    const SupplyConditionDescriptionListDataSelectors;

//! typedef for const type SupplyConditionDescriptionListDataSelectors
using SupplyConditionDescriptionListDataSelectorsConstPtr =
    std::shared_ptr<SupplyConditionDescriptionListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONDESCRIPTIONLISTDATASELECTORS_H_