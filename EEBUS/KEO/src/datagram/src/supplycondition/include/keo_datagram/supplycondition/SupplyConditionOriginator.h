...
#ifndef KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONORIGINATOR_H_
#define KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONORIGINATOR_H_
...
/**
 * Declaration SupplyConditionOriginator
 */
class SupplyConditionOriginator : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 5;

  //! Enumeration SupplyConditionOriginator::Value
  enum class Value {
    UNDEFINED__ = -1,
    EXTERN_DSO,
    EXTERN_SUPPLIER,
   ...
   */
  SupplyConditionOriginator(SupplyConditionOriginator::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  SupplyConditionOriginator(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static SupplyConditionOriginator fromString(const std::string &c_text);
   ...
   */
  SupplyConditionOriginator::Value getValue() const;
   ...
   * @return enumeration value
   */
  SupplyConditionOriginator::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const SupplyConditionOriginator &other) const;
...
private:
  ...
  SupplyConditionOriginator::Value m_data;
...
/**
 * \deprecated Use SupplyConditionOriginator instead.
 */
using SupplyConditionOriginatorStruct = SupplyConditionOriginator;
...
#endif // KEO_DATAGRAM_SUPPLYCONDITION_SUPPLYCONDITIONORIGINATOR_H_