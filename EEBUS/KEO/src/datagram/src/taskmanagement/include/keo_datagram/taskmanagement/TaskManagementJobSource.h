...
#ifndef KEO_DATAGRAM_TASKMANAGEMENT_TASKMANAGEMENTJOBSOURCE_H_
#define KEO_DATAGRAM_TASKMANAGEMENT_TASKMANAGEMENTJOBSOURCE_H_
...
/**
 * Declaration TaskManagementJobSource
 */
class TaskManagementJobSource : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 3;

  //! Enumeration TaskManagementJobSource::Value
  enum class Value {
    UNDEFINED__ = -1,
    INTERNAL_MECHANISM,
    USER_INTERACTION,
   ...
   */
  TaskManagementJobSource(TaskManagementJobSource::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  TaskManagementJobSource(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static TaskManagementJobSource fromString(const std::string &c_text);
   ...
   */
  TaskManagementJobSource::Value getValue() const;
   ...
   * @return enumeration value
   */
  TaskManagementJobSource::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const TaskManagementJobSource &other) const;
...
private:
  ...
  TaskManagementJobSource::Value m_data;
...
/**
 * \deprecated Use TaskManagementJobSource instead.
 */
using TaskManagementJobSourceStruct = TaskManagementJobSource;
...
#endif // KEO_DATAGRAM_TASKMANAGEMENT_TASKMANAGEMENTJOBSOURCE_H_