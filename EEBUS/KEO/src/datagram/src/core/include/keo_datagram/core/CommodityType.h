...
#ifndef KEO_DATAGRAM_CORE_COMMODITYTYPE_H_
#define KEO_DATAGRAM_CORE_COMMODITYTYPE_H_
...
/**
 * Declaration CommodityType
 */
class CommodityType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 11;

  //! Enumeration CommodityType::Value
  enum class Value {
    UNDEFINED__ = -1,
    ELECTRICITY,
    GAS,
   ...
   */
  CommodityType::Value getValue() const;
   ...
   * @return enumeration value
   */
  CommodityType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const CommodityType &other) const;
...
/**
 * \deprecated Use CommodityType instead.
 */
using CommodityTypeStruct = CommodityType;
...
#endif // KEO_DATAGRAM_CORE_COMMODITYTYPE_H_