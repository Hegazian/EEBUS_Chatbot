...
#ifndef KEO_DATAGRAM_CORE_CURRENCY_H_
#define KEO_DATAGRAM_CORE_CURRENCY_H_
 ...
 */
class Currency : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 178;

  //! Enumeration Currency::Value
  enum class Value {
    UNDEFINED__ = -1,
    AED,
    AFN,
...
#endif // KEO_DATAGRAM_CORE_CURRENCY_H_