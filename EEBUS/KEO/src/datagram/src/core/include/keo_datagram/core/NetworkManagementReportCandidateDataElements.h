...
#ifndef KEO_DATAGRAM_CORE_NETWORKMANAGEMENTREPORTCANDIDATEDATAELEMENTS_H_
#define KEO_DATAGRAM_CORE_NETWORKMANAGEMENTREPORTCANDIDATEDATAELEMENTS_H_
...
/**
 * Declaration NetworkManagementReportCandidateDataElements
 */
class NetworkManagementReportCandidateDataElements : public DataElements {
public:
  /**
...
//! NetworkManagementReportCandidateDataElements
using NetworkManagementReportCandidateDataElementsPtr =
    std::shared_ptr<NetworkManagementReportCandidateDataElements>;

//! typedef for const type NetworkManagementReportCandidateDataElements
using NetworkManagementReportCandidateDataElementsConst =
    const NetworkManagementReportCandidateDataElements;

//! typedef for const type NetworkManagementReportCandidateDataElements
using NetworkManagementReportCandidateDataElementsConstPtr =
    std::shared_ptr<NetworkManagementReportCandidateDataElementsConst>;
...
#endif // KEO_DATAGRAM_CORE_NETWORKMANAGEMENTREPORTCANDIDATEDATAELEMENTS_H_