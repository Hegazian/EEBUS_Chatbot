...
#ifndef KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTENTRYDATA_H_
#define KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTENTRYDATA_H_
...
/**
 * Declaration SubscriptionManagementEntryData
 */
class SubscriptionManagementEntryData : public KeoJsonTransformable {
public:
  /**
   ...
   */
  bool operator==(const SubscriptionManagementEntryData &c_classObject) const;
   ...
   */
  SubscriptionManagementEntryData
  reduce(const SubscriptionManagementEntryDataElements &elements) const;
...
//! typedef for non-const smart pointer type SubscriptionManagementEntryData
using SubscriptionManagementEntryDataPtr =
    std::shared_ptr<SubscriptionManagementEntryData>;

//! typedef for const type SubscriptionManagementEntryData
using SubscriptionManagementEntryDataConst =
    const SubscriptionManagementEntryData;

//! typedef for const type SubscriptionManagementEntryData
using SubscriptionManagementEntryDataConstPtr =
    std::shared_ptr<SubscriptionManagementEntryDataConst>;
...
#endif // KEO_DATAGRAM_CORE_SUBSCRIPTIONMANAGEMENTENTRYDATA_H_