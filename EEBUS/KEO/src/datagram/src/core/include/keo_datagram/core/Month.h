...
#ifndef KEO_DATAGRAM_CORE_MONTH_H_
#define KEO_DATAGRAM_CORE_MONTH_H_
...
public:
  ...
  */
  Month(Month::Value c_data);

  /**
  * Construct from string.
  * @param c_text Classifier string
  */
  explicit Month(const std::string &c_text);
   ...
   */
  static Month::Value fromString(const std::string &c_text);
   ...
   */
  bool operator==(const Month &c_enumCmdClassifier) const;
...
#endif // KEO_DATAGRAM_CORE_MONTH_H_