...
#ifndef KEO_DATAGRAM_CORE_BILLTYPE_H_
#define KEO_DATAGRAM_CORE_BILLTYPE_H_
...
/**
 * Declaration BillType
 */
class BillType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 1;

  //! Enumeration BillType::Value
  enum class Value { UNDEFINED__ = -1, CHARGING_SUMMARY };
   ...
   * @return enumeration value
   */
  BillType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const BillType &other) const;
...
/**
 * \deprecated Use BillType instead.
 */
using BillTypeStruct = BillType;
...
#endif // KEO_DATAGRAM_CORE_BILLTYPE_H_