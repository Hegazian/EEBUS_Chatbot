...
BindingManagementDeleteCall::BindingManagementDeleteCall()
    : CmdData(), m_bindingIdIsSet(false), m_bindingId(0),
...
BindingManagementDeleteCall::BindingManagementDeleteCall(
    ...
    : CmdData(), m_bindingIdIsSet(true), m_bindingId(c_bindingId),
      m_clientAddressIsSet(true), m_clientAddress(c_clientAddress),
      m_serverAddressIsSet(true), m_serverAddress(c_serverAddress)

{}

bool BindingManagementDeleteCall::
operator==(const BindingManagementDeleteCall &c_classObject) const {
...
bool BindingManagementDeleteCall::isEmpty() const {
  return !m_bindingIdIsSet && !m_clientAddressIsSet && !m_serverAddressIsSet;
}

CmdData::Type BindingManagementDeleteCall::getDataType() const {
  return CmdData::Type::BINDING_MANAGEMENT_DELETE_CALL_TYPE;
}

CmdDataPtr BindingManagementDeleteCall::clone() const {
  return std::make_shared<BindingManagementDeleteCall>(*this);
}

void BindingManagementDeleteCall::setBindingId(
    const xs_unsignedInt &bindingId) {
  m_bindingId = bindingId;
  m_bindingIdIsSet = true;
}

const xs_unsignedInt &BindingManagementDeleteCall::getBindingId() const {
  return m_bindingId;
}

void BindingManagementDeleteCall::cleanBindingId() {
  m_bindingId = 0;
  m_bindingIdIsSet = false;
}

bool BindingManagementDeleteCall::getBindingIdIsSet() const {
  return m_bindingIdIsSet;
}

void BindingManagementDeleteCall::setClientAddress(
    const FeatureAddress &clientAddress) {
  m_clientAddress = clientAddress;
  m_clientAddressIsSet = true;
}

const FeatureAddress &BindingManagementDeleteCall::getClientAddress() const {
  return m_clientAddress;
}

void BindingManagementDeleteCall::cleanClientAddress() {
  m_clientAddress = FeatureAddress();
  m_clientAddressIsSet = false;
}

bool BindingManagementDeleteCall::getClientAddressIsSet() const {
  return m_clientAddressIsSet;
}

void BindingManagementDeleteCall::setServerAddress(
    const FeatureAddress &serverAddress) {
  m_serverAddress = serverAddress;
  m_serverAddressIsSet = true;
}

const FeatureAddress &BindingManagementDeleteCall::getServerAddress() const {
  return m_serverAddress;
}

void BindingManagementDeleteCall::cleanServerAddress() {
  m_serverAddress = FeatureAddress();
  m_serverAddressIsSet = false;
}

bool BindingManagementDeleteCall::getServerAddressIsSet() const {
  return m_serverAddressIsSet;
}

CmdDataPtr
BindingManagementDeleteCall::reduce(const std::vector<Filter> &filters) const {
...
bool BindingManagementDeleteCall::fromJson(KeoJsonValue *json) {
  if (!json->empty()) {
...
std::string BindingManagementDeleteCall::toJson() const {
  std::string result = "[";
  if (m_bindingIdIsSet) {
