...
CommodityData::CommodityData()
    : m_commodityIdIsSet(false), m_commodityId(0), m_commodityTypeIsSet(false),
...
bool CommodityData::operator==(const CommodityData &c_classObject) const {
...
bool CommodityData::isEmpty() const {
  return !m_commodityIdIsSet && !m_commodityTypeIsSet &&
         !m_positiveEnergyDirectionIsSet && !m_labelIsSet &&
         !m_descriptionIsSet;
}

void CommodityData::setCommodityId(const xs_unsignedInt &commodityId) {
  m_commodityId = commodityId;
  m_commodityIdIsSet = true;
}

const xs_unsignedInt &CommodityData::getCommodityId() const {
  return m_commodityId;
}

void CommodityData::cleanCommodityId() {
  m_commodityId = 0;
  m_commodityIdIsSet = false;
}

bool CommodityData::getCommodityIdIsSet() const { return m_commodityIdIsSet; }

void CommodityData::setCommodityType(const CommodityType &commodityType) {
  m_commodityType = commodityType;
  m_commodityTypeIsSet = true;
}

const CommodityType &CommodityData::getCommodityType() const {
  return m_commodityType;
}

void CommodityData::cleanCommodityType() {
  m_commodityType = CommodityType();
  m_commodityTypeIsSet = false;
}

bool CommodityData::getCommodityTypeIsSet() const {
  return m_commodityTypeIsSet;
}

void CommodityData::setPositiveEnergyDirection(
...
const EnergyDirection &CommodityData::getPositiveEnergyDirection() const {
  return m_positiveEnergyDirection;
}

void CommodityData::cleanPositiveEnergyDirection() {
  m_positiveEnergyDirection = EnergyDirection();
  m_positiveEnergyDirectionIsSet = false;
}

bool CommodityData::getPositiveEnergyDirectionIsSet() const {
  return m_positiveEnergyDirectionIsSet;
}

void CommodityData::setLabel(const xs_string &label) {
  m_label = label;
  m_labelIsSet = true;
}

const xs_string &CommodityData::getLabel() const { return m_label; }

void CommodityData::cleanLabel() {
  m_label = "";
  m_labelIsSet = false;
}

bool CommodityData::getLabelIsSet() const { return m_labelIsSet; }

void CommodityData::setDescription(const xs_string &description) {
  m_description = description;
  m_descriptionIsSet = true;
}

const xs_string &CommodityData::getDescription() const { return m_description; }

void CommodityData::cleanDescription() {
  m_description = "";
  m_descriptionIsSet = false;
}

bool CommodityData::getDescriptionIsSet() const { return m_descriptionIsSet; }

CommodityData
CommodityData::reduce(const CommodityDataElements &elements) const {
  CommodityData dataOut;
...
bool CommodityData::fromJson(KeoJsonValue *json) {
  if (!json->empty()) {
...
std::string CommodityData::toJson() const {
  std::string result = "[";
