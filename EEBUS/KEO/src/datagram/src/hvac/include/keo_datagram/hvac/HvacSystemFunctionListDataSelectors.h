...
#ifndef KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONLISTDATASELECTORS_H_
#define KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONLISTDATASELECTORS_H_
...
/**
 * Declaration HvacSystemFunctionListDataSelectors
 */
class HvacSystemFunctionListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  explicit HvacSystemFunctionListDataSelectors(
   ...
   */
  bool selects(const HvacSystemFunctionData &data) const;
...
//! typedef for non-const smart pointer type HvacSystemFunctionListDataSelectors
using HvacSystemFunctionListDataSelectorsPtr =
    std::shared_ptr<HvacSystemFunctionListDataSelectors>;

//! typedef for const type HvacSystemFunctionListDataSelectors
using HvacSystemFunctionListDataSelectorsConst =
    const HvacSystemFunctionListDataSelectors;

//! typedef for const type HvacSystemFunctionListDataSelectors
using HvacSystemFunctionListDataSelectorsConstPtr =
    std::shared_ptr<HvacSystemFunctionListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_HVAC_HVACSYSTEMFUNCTIONLISTDATASELECTORS_H_