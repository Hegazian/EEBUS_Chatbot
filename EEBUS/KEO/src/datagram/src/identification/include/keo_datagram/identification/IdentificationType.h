...
#ifndef KEO_DATAGRAM_IDENTIFICATION_IDENTIFICATIONTYPE_H_
#define KEO_DATAGRAM_IDENTIFICATION_IDENTIFICATIONTYPE_H_
...
/**
 * Declaration IdentificationType
 */
class IdentificationType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 3;

  //! Enumeration IdentificationType::Value
  enum class Value { UNDEFINED__ = -1, EUI48, EUI64, USER_RFID_TAG };
   ...
   */
  IdentificationType(IdentificationType::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  IdentificationType(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static IdentificationType fromString(const std::string &c_text);
   ...
   */
  IdentificationType::Value getValue() const;
   ...
   * @return enumeration value
   */
  IdentificationType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const IdentificationType &other) const;
...
private:
  ...
  IdentificationType::Value m_data;
...
/**
 * \deprecated Use IdentificationType instead.
 */
using IdentificationTypeStruct = IdentificationType;
...
#endif // KEO_DATAGRAM_IDENTIFICATION_IDENTIFICATIONTYPE_H_