...
#ifndef KEO_DATAGRAM_INCENTIVETABLE_TIERTYPE_H_
#define KEO_DATAGRAM_INCENTIVETABLE_TIERTYPE_H_
...
/**
 * Declaration TierType
 */
class TierType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 2;

  //! Enumeration TierType::Value
  enum class Value { UNDEFINED__ = -1, FIXED_COST, DYNAMIC_COST };
   ...
   * @return enumeration value
   */
  TierType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const TierType &other) const;
...
/**
 * \deprecated Use TierType instead.
 */
using TierTypeStruct = TierType;
...
#endif // KEO_DATAGRAM_INCENTIVETABLE_TIERTYPE_H_