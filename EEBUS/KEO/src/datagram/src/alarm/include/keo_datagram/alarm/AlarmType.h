...
#ifndef KEO_DATAGRAM_ALARM_ALARMTYPE_H_
#define KEO_DATAGRAM_ALARM_ALARMTYPE_H_
...
/**
 * Declaration AlarmType
 */
class AlarmType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 3;

  //! Enumeration AlarmType::Value
  enum class Value {
    UNDEFINED__ = -1,
    ALARM_CANCELLED,
    UNDER_THRESHOLD,
   ...
   */
  AlarmType::Value getValue() const;
   ...
   * @return enumeration value
   */
  AlarmType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const AlarmType &other) const;
...
/**
 * \deprecated Use AlarmType instead.
 */
using AlarmTypeStruct = AlarmType;
...
#endif // KEO_DATAGRAM_ALARM_ALARMTYPE_H_