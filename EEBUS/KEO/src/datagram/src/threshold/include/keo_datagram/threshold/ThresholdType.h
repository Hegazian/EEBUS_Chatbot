...
#ifndef KEO_DATAGRAM_THRESHOLD_THRESHOLDTYPE_H_
#define KEO_DATAGRAM_THRESHOLD_THRESHOLDTYPE_H_
...
/**
 * Declaration ThresholdType
 */
class ThresholdType : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 10;

  //! Enumeration ThresholdType::Value
  enum class Value {
    UNDEFINED__ = -1,
    GOOD_ABOVE,
    BAD_ABOVE,
    ...
    MIN_VALUE_THRESHOLD,
    MAX_VALUE_THRESHOLD,
    MIN_VALUE_THRESHOLD_EXTREME,
    MAX_VALUE_THRESHOLD_EXTREME,
    SAG_THRESHOLD,
    SWELL_THRESHOLD
  };
   ...
   */
  ThresholdType::Value getValue() const;
   ...
   * @return enumeration value
   */
  ThresholdType::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const ThresholdType &other) const;
...
/**
 * \deprecated Use ThresholdType instead.
 */
using ThresholdTypeStruct = ThresholdType;
...
#endif // KEO_DATAGRAM_THRESHOLD_THRESHOLDTYPE_H_