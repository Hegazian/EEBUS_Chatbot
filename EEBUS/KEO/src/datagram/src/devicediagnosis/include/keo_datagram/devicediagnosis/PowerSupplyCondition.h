...
#ifndef KEO_DATAGRAM_DEVICEDIAGNOSIS_POWERSUPPLYCONDITION_H_
#define KEO_DATAGRAM_DEVICEDIAGNOSIS_POWERSUPPLYCONDITION_H_
...
/**
 * Declaration PowerSupplyCondition
 */
class PowerSupplyCondition : public ExtendableSpineEnum {
public:
  //! Number of possible enumeration values
  const static std::size_t MAX_ENUM = 5;

  //! Enumeration PowerSupplyCondition::Value
  enum class Value { UNDEFINED__ = -1, GOOD, LOW, CRITICAL, UNKNOWN, ERROR };
   ...
   */
  PowerSupplyCondition(PowerSupplyCondition::Value value);

  /**
   * Constructs an instance and sets its value from string.
   * @param value the value of the new instance
   */
  PowerSupplyCondition(const std::string &value);

  /**
   * Constructs the enumeration value from string.
   * @returns An enumeration object created from the string
   */
  static PowerSupplyCondition fromString(const std::string &c_text);
   ...
   */
  PowerSupplyCondition::Value getValue() const;
   ...
   * @return enumeration value
   */
  PowerSupplyCondition::Value getData() const;

  /**
   * Comparison operator ==
   * @param other object to compare
   */
  bool operator==(const PowerSupplyCondition &other) const;
...
private:
  ...
  PowerSupplyCondition::Value m_data;
...
/**
 * \deprecated Use PowerSupplyCondition instead.
 */
using PowerSupplyConditionStruct = PowerSupplyCondition;
...
#endif // KEO_DATAGRAM_DEVICEDIAGNOSIS_POWERSUPPLYCONDITION_H_