...
#ifndef KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTVALUELISTDATASELECTORS_H_
#define KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTVALUELISTDATASELECTORS_H_
...
/**
 * Declaration PowerTimeSlotValueListDataSelectors
 */
class PowerTimeSlotValueListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  bool selects(const PowerTimeSlotValueData &data) const;
...
//! typedef for non-const smart pointer type PowerTimeSlotValueListDataSelectors
using PowerTimeSlotValueListDataSelectorsPtr =
    std::shared_ptr<PowerTimeSlotValueListDataSelectors>;

//! typedef for const type PowerTimeSlotValueListDataSelectors
using PowerTimeSlotValueListDataSelectorsConst =
    const PowerTimeSlotValueListDataSelectors;

//! typedef for const type PowerTimeSlotValueListDataSelectors
using PowerTimeSlotValueListDataSelectorsConstPtr =
    std::shared_ptr<PowerTimeSlotValueListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_SMARTENERGYMANAGEMENTPS_POWERTIMESLOTVALUELISTDATASELECTORS_H_