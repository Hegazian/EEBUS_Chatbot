...
#ifndef KEO_DATAGRAM_MEASUREMENT_MEASUREMENTDATAELEMENTS_H_
#define KEO_DATAGRAM_MEASUREMENT_MEASUREMENTDATAELEMENTS_H_
...
/**
 * Declaration MeasurementDataElements
 */
class MeasurementDataElements : public DataElements {
public:
  /**
   ...
   */
  bool operator==(const MeasurementDataElements &c_classObject) const;
...
//! typedef for non-const smart pointer type MeasurementDataElements
using MeasurementDataElementsPtr = std::shared_ptr<MeasurementDataElements>;

//! typedef for const type MeasurementDataElements
using MeasurementDataElementsConst = const MeasurementDataElements;

//! typedef for const type MeasurementDataElements
using MeasurementDataElementsConstPtr =
    std::shared_ptr<MeasurementDataElementsConst>;
...
#endif // KEO_DATAGRAM_MEASUREMENT_MEASUREMENTDATAELEMENTS_H_