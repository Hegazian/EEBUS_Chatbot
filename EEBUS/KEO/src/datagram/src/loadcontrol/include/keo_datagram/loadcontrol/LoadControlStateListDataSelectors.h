...
#ifndef KEO_DATAGRAM_LOADCONTROL_LOADCONTROLSTATELISTDATASELECTORS_H_
#define KEO_DATAGRAM_LOADCONTROL_LOADCONTROLSTATELISTDATASELECTORS_H_
...
/**
 * Declaration LoadControlStateListDataSelectors
 */
class LoadControlStateListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  bool operator==(const LoadControlStateListDataSelectors &c_classObject) const;
   ...
   */
  bool selects(const LoadControlStateData &data) const;
...
//! typedef for non-const smart pointer type LoadControlStateListDataSelectors
using LoadControlStateListDataSelectorsPtr =
    std::shared_ptr<LoadControlStateListDataSelectors>;

//! typedef for const type LoadControlStateListDataSelectors
using LoadControlStateListDataSelectorsConst =
    const LoadControlStateListDataSelectors;

//! typedef for const type LoadControlStateListDataSelectors
using LoadControlStateListDataSelectorsConstPtr =
    std::shared_ptr<LoadControlStateListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_LOADCONTROL_LOADCONTROLSTATELISTDATASELECTORS_H_