...
#ifndef KEO_DATAGRAM_TIMEINFORMATION_TIMEINFORMATION_ALL_H_
#define KEO_DATAGRAM_TIMEINFORMATION_TIMEINFORMATION_ALL_H_
...
#endif // KEO_DATAGRAM_TIMEINFORMATION_TIMEINFORMATION_ALL_H_