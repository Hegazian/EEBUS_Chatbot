...
#ifndef KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONPARAMETERDESCRIPTIONLISTDATASELECTORS_H_
#define KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONPARAMETERDESCRIPTIONLISTDATASELECTORS_H_
...
/**
 * Declaration ElectricalConnectionParameterDescriptionListDataSelectors
 */
class ElectricalConnectionParameterDescriptionListDataSelectors
...
public:
   ...
   */
  bool selects(const ElectricalConnectionParameterDescriptionData &data) const;
...
//! ElectricalConnectionParameterDescriptionListDataSelectors
using ElectricalConnectionParameterDescriptionListDataSelectorsPtr =
    std::shared_ptr<ElectricalConnectionParameterDescriptionListDataSelectors>;

//! typedef for const type
//! ElectricalConnectionParameterDescriptionListDataSelectors
using ElectricalConnectionParameterDescriptionListDataSelectorsConst =
    const ElectricalConnectionParameterDescriptionListDataSelectors;

//! typedef for const type
//! ElectricalConnectionParameterDescriptionListDataSelectors
using ElectricalConnectionParameterDescriptionListDataSelectorsConstPtr =
    std::shared_ptr<
        ElectricalConnectionParameterDescriptionListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONPARAMETERDESCRIPTIONLISTDATASELECTORS_H_