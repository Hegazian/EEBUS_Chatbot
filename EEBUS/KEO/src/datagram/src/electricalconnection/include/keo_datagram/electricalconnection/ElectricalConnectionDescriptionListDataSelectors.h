...
#ifndef KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONDESCRIPTIONLISTDATASELECTORS_H_
#define KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONDESCRIPTIONLISTDATASELECTORS_H_
...
/**
 * Declaration ElectricalConnectionDescriptionListDataSelectors
 */
class ElectricalConnectionDescriptionListDataSelectors : public DataSelectors {
public:
  /**
   ...
   */
  bool operator==(const ElectricalConnectionDescriptionListDataSelectors
                      &c_classObject) const;
   ...
   */
  bool selects(const ElectricalConnectionDescriptionData &data) const;
...
//! ElectricalConnectionDescriptionListDataSelectors
using ElectricalConnectionDescriptionListDataSelectorsPtr =
    std::shared_ptr<ElectricalConnectionDescriptionListDataSelectors>;

//! typedef for const type ElectricalConnectionDescriptionListDataSelectors
using ElectricalConnectionDescriptionListDataSelectorsConst =
    const ElectricalConnectionDescriptionListDataSelectors;

//! typedef for const type ElectricalConnectionDescriptionListDataSelectors
using ElectricalConnectionDescriptionListDataSelectorsConstPtr =
    std::shared_ptr<ElectricalConnectionDescriptionListDataSelectorsConst>;
...
#endif // KEO_DATAGRAM_ELECTRICALCONNECTION_ELECTRICALCONNECTIONDESCRIPTIONLISTDATASELECTORS_H_