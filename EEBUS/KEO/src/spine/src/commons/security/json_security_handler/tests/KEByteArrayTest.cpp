...
/**
 * Tests the KEByteArray
 */
TEST(KEByteArray, Constructor_std_string)
{
    std::string s("test");
    KEByteArray ba(s);
 ...
 * Tests the KEByteArray
 */
TEST(KEByteArray, Constructor_char_ptr)
{
    char s[] = "test";
    KEByteArray ba(s);
 ...
 * Tests the KEByteArray
 */
TEST(KEByteArray, Constructor_char_ptr_size)
{
    char s[] = "test";
    KEByteArray ba(s, sizeof(s));
 ...
 * Tests the KEByteArray
 */
TEST(KEByteArray, Constructor_vector_char)
{
    char s[] = "test";
 ...
 * Tests the KEByteArray
 */
TEST(KEByteArray, Constructor_vector_uchar)
{
    char s[] = "test";
 ...
 * Tests the KEByteArray
 */
TEST(KEByteArray, Constructor_fill_char)
{
    char s[] = "test";
    std::vector<unsigned char> v(s, s + sizeof(s));
 ...
 * Tests the KEByteArray
 */
TEST(KEByteArray, to_from_hex)
{
    char s[] = "7400650073007400";
    KEByteArray ba = KEByteArray::fromHex(s);
 ...
 */
TEST(KEByteArray, ByteArrayBasic)
{
    // default c'tor, empty
    KEByteArray ba1;
    ...
    KEByteArray ba4("Never wanted this");
...
TEST(KEByteArray, ByteArrayHex)
{
    ...
    // FROM Hex
    KEByteArray ba3 = KEByteArray::fromHex("415a5A");
    ...
    EXPECT_EQ("11121314", KEByteArray(vc).toHex());
    ...
    EXPECT_EQ("f1f2f3f4", KEByteArray(vuc).toHex());
}
