...
#ifndef _MEASUREMENTCLIENTFEATURE_H_
#define _MEASUREMENTCLIENTFEATURE_H_
...
/**
 * @addtogroup keo_spine_combine_app
 * @{
 */
...
public:
     ...
     * Constructor
     */
    explicit MeasurementClientFeature(const std::vector<keo_datagram::xs_unsignedInt>& entity);
    ...
    /**
     * Removes all subscriptions for the given device
     * @param serverDeviceName device address of the given device
     */
    void removeSubscriptions(const std::string& serverDeviceName);
...
/** @} */ //  end of group keo_spine_combine_app
