...
#ifndef __SHIP__ConnectionPinError__H__
#define __SHIP__ConnectionPinError__H__
...
/* ****************************************************************************** *
 *  class ConnectionPinError: definition                                         
 * ****************************************************************************** */
/** Generated class for ConnectionPinError **/

class ConnectionPinError : public CShipDataClass
{
public:
    ...
    * @param c_error 
    */
	ConnectionPinError ( const xs_unsignedByte& c_error);   


    /** Desctructor
    * Empty destructor.
    */
	virtual ~ConnectionPinError ();
...
/** @}
 */
#endif //__SHIP__ConnectionPinError__H__
