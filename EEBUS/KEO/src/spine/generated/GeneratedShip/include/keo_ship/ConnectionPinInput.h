...
#ifndef __SHIP__ConnectionPinInput__H__
#define __SHIP__ConnectionPinInput__H__
...
/* ****************************************************************************** *
 *  class ConnectionPinInput: definition                                         
 * ****************************************************************************** */
/** Generated class for ConnectionPinInput **/

class ConnectionPinInput : public CShipDataClass
{
public:
    ...
    * @param c_pin 
    */
	ConnectionPinInput ( const xs_string& c_pin);   


    /** Desctructor
    * Empty destructor.
    */
	virtual ~ConnectionPinInput ();
	...
	/** getPin
	* Getter method for data member pin
	* @return xs_string: value of the member
	*/
	xs_string getPin(void) const;

	/** getPinIsSet
	* Getter method to query if data member pin is set
	* @return bool: true if pin is set, else false
	*/
	bool getPinIsSet(void) const;


	/** setPin
	* Setter method for data member pin
	* @param c_value value that will be assigned to the data member
	*/
	void setPin(const xs_string& c_value);

	/** cleanPin
	* Cleaner for the pin member
	*/
	void cleanPin(void);

private:
	/** true, if the mandatory elementary data member has been set, else false */
	unsigned char m_pinIsSet:1;
...
/** @}
 */
#endif //__SHIP__ConnectionPinInput__H__
