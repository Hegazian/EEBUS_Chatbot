...
#ifndef __SHIP__PinState__H__
#define __SHIP__PinState__H__
...
public:
	...
	PinState()
        : m_data(PINSTATE_UNDEFINED__)
    { };

	PinState(enumPinState c_data)
        : m_data(c_data)
    { };

	PinState(const std::string& c_text);
     ...
     */
    static enumPinState fromString(const std::string& c_text);
...
private:
    ...
    static const char* enumString[4]; 
